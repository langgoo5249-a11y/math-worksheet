...
# 读取新采集器
with open(r"C:\Users\Administrator\.qclaw\workspace-agent-3bb7b585\collector_v6.py", "r", encoding="utf-8") as f:
...
# 测试
print("\n测试采集器（2.5分钟）...")
stdin, stdout, stderr = ssh.exec_command("cd /www/wwwroot/resource_site/auto_collect && timeout 150 python3 collector.py 2>&1", timeout=180)
