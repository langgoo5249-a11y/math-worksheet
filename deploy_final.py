...
# Upload to correct path: assets/css/custom-style.css
...
sftp.close()
print('CSS uploaded to assets/css/custom-style.css')

# Update version in functions.php to 1.0.1 to bust cache
stdin, stdout, stderr = client.exec_command(
    "sed -i \"s/'1.0.0');/'1.0.1');/\" /www/wwwroot/skillxm.cn/public/wp-content/themes/puock/functions.php",
    timeout=10
)
stdout.read()
print('Version bumped to 1.0.1')

# Verify functions.php now references 1.0.1
stdin, stdout, stderr = client.exec_command(
    "grep -n \"custom-style.css\\|1.0.1\" /www/wwwroot/skillxm.cn/public/wp-content/themes/puock/functions.php",
    timeout=10
)
print('Functions.php check:')
