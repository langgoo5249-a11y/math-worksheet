 ...
 * @LastEditTime: 2024-04-09 19:32:22
 ...
 * @return {*}
 */
function zibpay_get_vip_exchange_card($card, $password)
{
    $msg_db = ZibCardPass::get_row(array('card' => $card, 'password' => $password, 'type' => 'vip_exchange'));
    return $msg_db;
}
