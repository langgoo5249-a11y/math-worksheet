 ...
 * @LastEditTime: 2024-04-09 19:32:15
 ...
 * @return {*}
 */
function zibpay_get_post_cashier_link($post_id = 0, $class = 'but jb-red', $con = '立即赞助')
{
 ...
 * @return {*}
 */
function zibpay_get_post_points_cashier_link($post_id = 0, $class = 'but jb-yellow', $con = '立即赞助')
{
