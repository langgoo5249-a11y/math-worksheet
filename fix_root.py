...
config = '''server {
    ...
    # 静态资源缓存
    location ~* \\.(js|css|png|jpg|jpeg|gif|ico|svg|woff|woff2|ttf|html)$ {
        expires 7d;
...
if "skycaiji" in content.lower() or "天空" in content or "采集" in content or "安装" in content:
    print("✓ 天空采集器页面!")
    print(content[:1000])
else:
