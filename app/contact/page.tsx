...
export const metadata: Metadata = {
  title: '联系我们 - 练学�?,
  description: "联系练学宝团队：如有问题、建议或合作意向，欢迎通过邮箱 lang@skillxm.cn 或在线表单联系我们。电�?575-64972527，地址浙江省绍兴市嵊州三江街道花园社区75号。我们会�?-2个工作日内回复您的邮件，欢迎家长教师和合作伙伴咨询交流，共同为小学生提供更好的免费学习工具和教育资源�?,
  alternates: {
    ...
    <SiteLayout>
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-base sm:text-lg">我们很乐意听取您的声�?/p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-4 sm:p-8 text-center">
              ...
              <p className="text-gray-300 mt-4 leading-relaxed">
                如果您有任何问题、建议或合作意向，欢迎通过邮件联系我们。我们会�?-3个工作日内回复您的邮件�?
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-white font-medium">一般咨�?/span>
                </div>
                <p className="text-gray-400 text-sm">1-3个工作日内回�?/p>
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-gray-400 text-sm">1-2个工作日内回�?/p>
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-gray-400 text-sm">3-5个工作日内回�?/p>
              </div>
            </div>
