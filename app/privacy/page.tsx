    ...
    <SiteLayout>
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">最后更新日期：2026年7月5日</p>
          <p className="text-gray-500 text-sm mt-2">生效日期：2026年7月5日</p>
        </div>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  ...
                  <li><strong>Google AdSense Cookie</strong>：本站使用 Google AdSense 展示广告。Google 可能通过 Cookie（如 __gads、IDE、NID 等）向您展示根据您的兴趣和过往浏览行为定制的广告。您可以通过访问 <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Google 广告设置</a> 管理广告个性化偏好，或访问 <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">aboutads.info</a> 选择退出个性化广告。</li>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-white font-medium mb-2">2.2 广告与 Cookie</h3>
                <p>本站通过 Google AdSense 展示广告以维持网站运营。Google AdSense 是 Google 提供的广告服务，可能使用 Cookie 来展示基于您兴趣的广告。具体情况如下：</p>
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  ...
                  <li>第三方供应商（如 Google）可能使用 Cookie 来衡量广告效果并提供更相关的广告内容</li>
                  <li>本站不直接收集或存储用于广告定向的个人信息</li>
                </ul>
              </div>
              <div>
                <h3 className="text-white font-medium mb-2">2.3 不用于其他商业营销</h3>
                <p>除上述 Google AdSense 广告服务外，我们不会将收集到的任何数据用于其他商业营销、出售给第三方或用于用户画像。本站承诺核心学习工具功能永久免费。</p>
              </div>
            </div>
          </div>
        </section>
