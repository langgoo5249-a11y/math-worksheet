    ...
    <SiteLayout>
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">最后更新日期：2026�?�?�?/p>
          <p className="text-gray-500 text-sm mt-2">生效日期�?026�?�?�?/p>
        </div>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-3">
              练学宝（以下简�?我们"�?本站"）非常重视用户隐私保护。本隐私政策旨在向您说明我们如何收集、使用、存储和保护您的信息，以及您享有的相关权利�?
            </p>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  ...
                  <li><strong>Google AdSense Cookie</strong>：本站使�?Google AdSense 展示广告。Google 可能通过 Cookie（如 __gads、IDE、NID 等）向您展示根据您的兴趣和过往浏览行为定制的广告。您可以通过访问 <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Google 广告设置</a> 管理广告个性化偏好，或访问 <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">aboutads.info</a> 选择退出个性化广告�?/li>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📊</span> 二、信息使用方�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  <li>Google AdSense 可能使用 Cookie（如 __gads、IDE）来根据您过往访问本站及其他网站的情况展示广告</li>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">🛡�?/span> 五、数据安�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">👶</span> 六、儿童隐私保�?
            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">⚖️</span> 七、您的权�?
            </h2>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📝</span> 八、政策更�?
            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              我们可能会不时更新本隐私政策。更新后的政策将在本页面发布，并修改"最后更新日�?。重大变更时，我们会在网站首页或博客发布通知�?
            </p>
            <p className="text-gray-300 leading-relaxed">
