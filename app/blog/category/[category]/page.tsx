...
const categorySEOConfig: Record<string, {
  ...
  '工具推荐': {
    ...
    ability: '学习效率',
    intro: '免费工具的价值不在于「免费」，而在于能不能真的省下时间。这个专栏整理适合小学生使用的在线工具：练习卷生成、口算速练、字帖生成、拼音学习等，说明各自适合什么场景、什么年级，以及有哪些使用上的坑。评测标准统一：是否免费无门槛、是否支持打印、内容是否符合课标。',
  },
  '关于我们': {
  ...
  '数学': {
    keywords: ['儿童数学能力', '数学脑科学', '数感培养', '数学学习差异', '数学认知'],
    topics: '数学学习机制、数感发展、认知科学与数学能力的关系',
    ability: '数学认知',
    intro: '数学能力的差异，究竟来自天赋还是方法？这个专栏收录从脑科学角度解释数学学习机制的文章，讨论工作记忆、数感发展与练习方式之间的关系。与按题型组织的「数学学习」不同，这里关注的是「为什么会这样」——孩子卡住的地方背后是什么认知机制，家长又能据此调整什么。',
  },
  '工具教程': {
    keywords: ['作文模板生成器', '学习工具使用教程', '工具实操步骤', '写作工具'],
    topics: '具体工具的使用步骤与实操方法',
    ability: '工具实操',
    intro: '这里放的是工具使用教程：如何用一个具体工具解决一个具体问题。每篇都按步骤写清「什么时候用、怎么用、用完之后做什么」，而不是泛泛罗列工具功能。目前以作文模板生成器等写作类工具为主，后续会补充其他工具的实操步骤。',
  },
  '综合教育': {
