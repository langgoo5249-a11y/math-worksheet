      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebPage',
            '@id': 'https://www.example.com/#homepage',
            name: '练学宝 - 免费小学在线学习工具',
            url: 'https://www.example.com/',
            description: '10+款免费小学教学工具，覆盖数学计算、语文练字、练习卷下载，即开即用无需注册。',
            inLanguage: 'zh-CN',
              ...
              itemListElement: [
                {
                  ...
                  position: 1,
                  name: '数学练习卷生成器',
                  url: 'https://www.example.com/tools/math-worksheet/',
                },
                {
                  '@type': 'ListItem',
                  position: 2,
                  name: '字帖生成器',
                  url: 'https://www.example.com/tools/calligraphy/',
                },
                {
                  '@type': 'ListItem',
                  position: 3,
                  name: '口算速练',
                  url: 'https://www.example.com/tools/mental-math/',
                },
                {
                  '@type': 'ListItem',
                  position: 4,
                  name: '数独游戏',
                  url: 'https://www.example.com/tools/sudoku/',
                },
                {
                  '@type': 'ListItem',
                  position: 5,
                  name: '识字卡片',
                  url: 'https://www.example.com/tools/flashcards/',
                },
                {
                  '@type': 'ListItem',
                  position: 6,
                  name: '作文模板',
                  url: 'https://www.example.com/tools/writing-template/',
                },
                {
                  '@type': 'ListItem',
                  position: 7,
                  name: '古诗词默写',
                  url: 'https://www.example.com/tools/poem-memo/',
                },
                {
                  '@type': 'ListItem',
                  position: 8,
                  name: '单元测试卷',
                  url: 'https://www.example.com/tools/unit-test/',
                },
                {
                  '@type': 'ListItem',
                  position: 9,
                  name: '英语字帖',
                  url: 'https://www.example.com/tools/english-calligraphy/',
                },
                {
                  '@type': 'ListItem',
                  position: 10,
                  name: '拼音注音',
                  url: 'https://www.example.com/tools/pinyin/',
                },
              ],
            },
          }),
