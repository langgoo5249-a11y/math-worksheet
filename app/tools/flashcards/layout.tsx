...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "免费生成汉字识字卡片，自动标注拼音并提供常用组词，支持双面卡片PDF打印。适合幼儿园大班到小学低年级识字启蒙，涵盖一年级常用300字和二年级常用500字，家长打印即可使用，教师可用于课堂识字教学，支持自定义生字内容与课文同步，配笔顺动画演示，可重复打印永久免费无需注册。",
