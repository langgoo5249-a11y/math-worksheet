...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "免费在线生成小学1-6年级数学练习卷，支持加减乘除、竖式计算、四则混合运算、填空题、应用题、图形题等11种题型，随机出题不重复，一键导出PDF打印。适合家长辅导和教师备课，覆盖人教版北师大版苏教版教材同步内容，每日练习提升计算能力和解题速度，配答案详解可重复打印永久免费无需注册。",
