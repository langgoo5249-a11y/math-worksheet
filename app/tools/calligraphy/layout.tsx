...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "免费在线生成田字格、米字格汉字字帖，支持楷体描红和临摹双模式，可自定义输入任意汉字、古诗词、课文内容，一键导出PDF打印。适合小学1-6年级语文生字练习和课后练字作业，替代传统描红字帖本，与部编版教材同步生字表，家长教师零成本使用，支持自定义字体大小和格数，可重复打印永久免费。",
