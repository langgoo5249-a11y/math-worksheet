...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: 'https://www.skillxm.cn/privacy-policy/',
    title: '隐私政策 - 练学�?,
    description: "练学宝隐私政策：详细说明我们如何收集、使用、存储和保护用户个人信息。练学宝不要求注册登录，不收集敏感个人信息，仅使用必要的Cookie保障网站正常运行�?,
    type: 'website',
    ...
    <SiteLayout>
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-3">
              练学宝（以下简�?我们"�?本站"）非常重视用户隐私保护。本隐私政策旨在向您说明我们如何收集、使用、存储和保护您的信息，以及您享有的相关权利�?            </p>
            <p className="text-gray-300 leading-relaxed">
              使用本站服务即表示您同意本隐私政策中描述的信息收集和使用方式。如果您不同意本政策，请停止使用本站服务�?            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
                <h3 className="text-white font-medium mb-2">1.1 我们不收集个人信�?/h3>
                <p>本站所有工具均在您的浏览器本地运行，不需要注册账号，不要求您提供姓名、邮箱、电话、地址等任何个人身份信息。您生成的练习卷、字帖、卡片等内容完全在本地处理，不会上传到我们的服务器�?/p>
              </div>
              <div>
                <h3 className="text-white font-medium mb-2">1.2 自动收集的匿名数�?/h3>
              ...
              <div>
                <h3 className="text-white font-medium mb-2">1.3 Cookie 和本地存�?/h3>
                <p>本站使用以下类型�?Cookie 和本地存储技术：</p>
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  <li><strong>分析�?Cookie</strong>：由百度统计设置，用于识别回头访客和统计网站流量。典�?Cookie 名称包括 Hm_lvt_*、Hm_lpvt_* 等，有效期通常�?年�?/li>
                  <li><strong>Cloudflare Cookie</strong>：包�?__cf_bm（安全防护）�?cf_clearance（人机验证），用于防范恶意访问和保障网站安全�?/li>
                  <li><strong>Google AdSense Cookie</strong>：本站使�?Google AdSense 展示广告。Google 可能通过 Cookie（如 __gads、IDE、NID 等）向您展示根据您的兴趣和过往浏览行为定制的广告。您可以通过访问 <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Google 广告设置</a> 管理广告个性化偏好�?/li>
                  <li><strong>本地存储（LocalStorage�?/strong>：本站工具可能使用浏览器�?LocalStorage 保存您的偏好设置（如选择的年级、题型等），这些数据仅存储在您的设备上，不会同步到服务器�?/li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📊</span> 二、信息使用方�?            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
                <h3 className="text-white font-medium mb-2">2.1 匿名统计数据的使�?/h3>
              ...
              <div>
                <h3 className="text-white font-medium mb-2">2.2 广告�?Cookie</h3>
                <p>本站通过 Google AdSense 展示广告以维持网站运营。Google AdSense �?Google 提供的广告服务，可能使用 Cookie 来展示基于您兴趣的广告。具体情况如下：</p>
                <ul className="list-disc list-inside mt-2 space-y-1 ml-4">
                  <li>Google AdSense 可能使用 Cookie 来根据您过往访问本站及其他网站的情况展示广告</li>
                  <li>您可以通过 <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Google 广告设置</a> 管理或关闭个性化广告</li>
                  <li>第三方供应商（如 Google）可能使�?Cookie 来衡量广告效果并提供更相关的广告内容</li>
                  <li>本站不直接收集或存储用于广告定向的个人信�?/li>
                </ul>
              </div>
              <div>
                <h3 className="text-white font-medium mb-2">2.3 不用于其他商业营销</h3>
                <p>除上�?Google AdSense 广告服务外，我们不会将收集到的任何数据用于其他商业营销、出售给第三方或用于用户画像。本站承诺核心学习工具功能永久免费�?/p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li><strong>第三方服务提供商</strong>：如前所述，百度统计�?Cloudflare 作为我们的服务提供商，会接触到匿名访问数据。这些第三方均受各自的数据保护政策约束�?/li>
                ...
                <table className="w-full text-sm mt-2">
                  <thead>
                    <tr className="border-b border-white/10">
                      ...
                      <th className="text-left text-white py-2 pr-4">用�?/th>
                  ...
                  <tbody className="text-gray-400">
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2 pr-4">CDN加速、网站托管、安全防�?/td>
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2 pr-4">广告展示服务（展示广告以维持网站免费运营�?/td>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">🛡�?/span> 五、数据安�?            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>虽然我们不收集个人信息，但我们仍然采取了以下措施保障网站安全�?/p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>全站 HTTPS 加密传输，通过 Cloudflare CDN 提供 HTTP/2 �?HTTP/3 支持</li>
                <li>Cloudflare 提供�?DDoS 防护�?Web 应用防火墙（WAF�?/li>
                <li>所有工具在浏览器端本地运行，用户数据不上传服务�?/li>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">👶</span> 六、儿童隐私保�?            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              本站的服务对象包括未成年人（主要是小学生及其家长）。我们深知保护儿童在线隐私的重要性�?            </p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300">
              <li>本站不收集任�?4岁以下儿童的个人信息</li>
              <li>不要求用户注册账号或提供任何身份信息</li>
              <li>不设有社交功能、聊天功能或用户互动功能</li>
              <li>工具生成的所有内容均在本地处理，不会上传或存�?/li>
            </ul>
            <p className="text-gray-300 leading-relaxed mt-3">
              如果您是家长或监护人，对本站的隐私保护有任何疑虑，欢迎随时联系我们�?            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">⚖️</span> 七、您的权�?            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">由于我们不收集个人信息，您无需担心数据泄露或滥用。但您仍然享有以下权利：</p>
            <ul className="list-disc list-inside space-y-1 ml-4 text-gray-300">
              <li><strong>拒绝 Cookie</strong>：您可以通过浏览器设置拒绝或删除 Cookie。大多数浏览器允许您�?设置"中管�?Cookie 偏好。请注意，拒�?Cookie 可能影响网站的部分统计功能，但不影响工具的核心使用�?/li>
              <li><strong>清除本地数据</strong>：您可以随时清除浏览器中�?LocalStorage 数据。在浏览器设置中找到"清除浏览数据"选项即可�?/li>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📝</span> 八、政策更�?            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              我们可能会不时更新本隐私政策。更新后的政策将在本页面发布，并修改"最后更新日�?。重大变更时，我们会在网站首页或博客发布通知�?            </p>
            <p className="text-gray-300 leading-relaxed">
              建议您定期查看本页面以了解最新的隐私保护措施。继续使用本站服务即表示您同意修改后的隐私政策�?            </p>
          </div>
        </section>
        ...
        <section>
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-4 sm:p-8 text-center">
            <p className="text-gray-300 leading-relaxed mb-3">
              如果您对本隐私政策有任何疑问、意见或建议，请通过邮件联系我们�?            </p>
            <a
