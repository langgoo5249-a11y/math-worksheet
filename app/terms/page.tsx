    ...
    <SiteLayout>
      <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📖</span> 一、服务说�?
            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              欢迎使用练学宝（以下简�?ldquo;本站&rdquo;）。本站提供免费的在线教育工具服务，包括但不限于数学练习卷生成器、字帖生成器、英语字帖、数独游戏、口算速练、识字卡片、作文模板和拼音注音等工具�?
            </p>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📋</span> 二、使用规�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-white font-medium mb-2">2.2 禁止商业用�?/h3>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">©�?/span> 三、知识产�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">⚠️</span> 四、免责声�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
                <h3 className="text-white font-medium mb-2">4.1 内容准确�?/h3>
              ...
              <div>
                <h3 className="text-white font-medium mb-2">4.3 服务可用�?/h3>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">🔒</span> 五、隐私保护与第三方服�?
            </h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div>
              ...
              <div>
                ...
                <p>百度统计等第三方服务可能会在您的浏览器中设置 Cookie。您可以通过浏览器设置拒�?Cookie，但这可能影响统计数据的准确性。更多信息请参阅我们�?<a href="/privacy/" className="text-blue-400 hover:text-blue-300">隐私政策</a>�?/p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-4 sm:p-8">
            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-xl">📝</span> 六、条款修�?
            </h2>
            <p className="text-gray-300 leading-relaxed mb-3">
              练学宝保留随时修改本服务条款的权利。修改后的条款将在本页面发布，并更新&ldquo;最后更新日�?rdquo;。继续使用本站服务即表示您同意修改后的条款�?
            </p>
            <p className="text-gray-300 leading-relaxed">
