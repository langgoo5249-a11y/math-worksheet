...
for article in articles:
    ...
    cursor.execute("INSERT INTO wp_posts (post_author, post_date, post_date_gmt, post_content, post_title, post_status, post_name, post_modified, post_modified_gmt, post_type) VALUES (1, %s, %s, %s, %s, 'publish', %s, %s, %s, 'post')", (now, now, content, title, post_name, now, now))
