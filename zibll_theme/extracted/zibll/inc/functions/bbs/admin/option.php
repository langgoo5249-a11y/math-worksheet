 ...
 * @LastEditTime: 2024-01-31 13:48:30
 */
/*
 * @Author        : Qinver
 * @Url           : zibll.com
...
<p>审核结果将会已站内信以及邮件的方式通知您，请注意查收</p>',
                ...
                array(
                    ...
                    'class'   => '',
                    'title'   => '后台编辑启用古腾堡编辑器' . $new_badge['7.4'],
    ...
    CSF::createSection($prefix, array(
        ...
        'fields'      => array(
            ...
            array(
                ...
                'type'         => 'repeater',
                'button_title' => '添加细分用户权限',
                'desc'         => '根据不同的用户类型，添加额外允许或禁止上传的文件格式（禁止的优先级大于允许）<div class="c-yellow">请添加文件的扩展名和MIME类型，用英文逗号分割。格式示例：<code>mp3=audio/mpeg,jpg=image/jpg</code></div><div class="c-red">郑重提示：请勿允许上传php、sh、exe等可执行文件，会极大的增加服务器被入侵攻击的风险</div>',
                'min'          => 1,
                'default'      => array(
                    array(
                        'type'    => 'admin',
