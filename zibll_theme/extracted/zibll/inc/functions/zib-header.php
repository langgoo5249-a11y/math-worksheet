 ...
 * @LastEditTime: 2024-04-09 19:27:02
...
function zib_header_user_box()
{
    ...
    if ($user_id) {
        ...
        if (is_super_admin()) {
            ...
            $href .= '<a rel="nofollow" target="_blank" href="' . zib_get_customize_widgets_url() . '" ><div class="badg mb6 toggle-radius c-yellow"><i class="fa fa-pie-chart"></i></div><div class="c-yellow">模块配置</div></a>';
...
function zib_header_slide()
{
    ...
    //叠加搜索组件
    $search_module_html = '';
    if (zib_m_pc_is_show(_pz('header_slider_search_s'))) {
    ...
    $card_module_html = '';
    $card_quantity    = 0;
    if (zib_m_pc_is_show(_pz('header_slider_card_s'))) {
