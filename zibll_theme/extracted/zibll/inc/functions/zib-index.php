 ...
 * @LastEditTime: 2023-10-31 19:50:23
...
function zib_index_tab_html($nav = 'nav')
{
    ...
    return '<div class="index-tab mb10 affix-header-sm relative" offset-top="-9"><ul style="width:100%;" class="scroll-x no-scrollbar">' . $html . '</ul></div>';
}
