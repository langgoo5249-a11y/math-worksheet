...
# New home-1.php with ad slots and mobile optimizations
new_home = '''<?php
...
/* Ad slots */
.ad-slot { background: #f8f9fa; border: 1px dashed #ddd; border-radius: 8px; display: flex; align-items: center; justify-content: center; min-height: 90px; margin: 15px 0; }
.ad-slot-label { color: #999; font-size: 12px; }
...
<div class="yy-main">
    <!-- Ad Slot 1: After Header (Mobile) -->
    <div class="container ad-slot ad-slot-mobile" style="min-height: 60px; margin-top: 10px;">
        <span class="ad-slot-label">广告位 1 (移动端)</span>
        <!-- Google AdSense 横幅广告 -->
        <!-- <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-4710405779358793" data-ad-slot="YOUR_SLOT_ID" data-ad-format="horizontal"></ins> -->
    </div>
    ...
    <!-- Ad Slot 2: After News Ticker -->
    <div class="container">
        <div class="ad-slot ad-slot-desktop" style="min-height: 90px;">
            <span class="ad-slot-label">广告位 2 (桌面端 - 横幅)</span>
        </div>
        <div class="ad-slot ad-slot-mobile" style="min-height: 50px;">
            <span class="ad-slot-label">广告位 2 (移动端)</span>
        </div>
    </div>

    <!-- Global Search Section - Larger on mobile -->
    ...
    <!-- Ad Slot 3: Before Content -->
    <div class="container">
        <div class="ad-slot ad-slot-desktop" style="min-height: 90px;">
            <span class="ad-slot-label">广告位 3 (桌面端 - 信息流前)</span>
        </div>
        <div class="ad-slot ad-slot-mobile" style="min-height: 50px;">
            <span class="ad-slot-label">广告位 3 (移动端)</span>
        </div>
    </div>
    ...
    <!-- Ad Slot 4: After Content (Footer) -->
    <div class="container">
        <div class="ad-slot ad-slot-desktop" style="min-height: 90px; margin-bottom: 20px;">
            <span class="ad-slot-label">广告位 4 (桌面端 - 页脚前)</span>
        </div>
        <div class="ad-slot ad-slot-mobile" style="min-height: 50px; margin-bottom: 15px;">
            <span class="ad-slot-label">广告位 4 (移动端)</span>
        </div>
    </div>
</div>
