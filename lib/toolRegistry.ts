...
export const TOOLS: ToolConfig[] = [
  {
    ...
    color: 'blue',
    schemaName: '古诗词默写生成器',
    schemaDescription: '收录240首经典古诗词默写练习卷，覆盖小学1-6年级必背古诗词及课外拓展，支持填空默写、全诗默写、上下句默写三种模式',
  ...
  },
  {
    ...
    color: 'orange',
    schemaName: '单元测试卷生成器',
    schemaDescription: '免费在线生成小学单元测试卷，支持数学、语文、英语、科学四科，覆盖人教版1-6年级上下册共305个单元，PDF导出即印即用',
    schemaCategory: 'EducationApplication',
    priority: 0.9,
    changefreq: 'weekly',
    active: true,
