...
export const GRADES: GradeConfig[] = [
  {
    ...
    metaDescription: '专为小学一年级学生设计的免费学习资源。包含一年级数学口算、10以内加减法、20以内进位加法（凑十法破十法）、拼音声母韵母、识字300字、字帖练字等核心知识点练习卷，配套口算速练、拼音注音、识字卡片、字帖生成器等在线工具，全部支持PDF免费下载打印，无需注册。适合6-7岁，按人教版部编版教材同步，家长辅导好帮手。',
  ...
  },
  {
    ...
    metaDescription: '专为小学二年级学生设计的免费学习资源。包含二年级九九乘法口诀、100以内加减法、表内乘除法、看图写话、阅读理解入门、字帖练习、英语26字母等核心知识点练习卷，配套口算速练、作文模板、英语字帖、字帖生成器等在线工具，全部支持PDF免费下载打印，无需注册。适合7-8岁，按人教版北师大版苏教版教材同步，家长辅导好帮手。',
  ...
  },
  {
    ...
    metaDescription: '专为小学三年级学生设计的免费学习资源。包含三年级数学万以内加减法、多位数乘除法、分数初步、英语单词、英语字帖、阅读理解、作文入门300字等核心练习卷，配套单元测试卷、口算速练、古诗词默写等在线工具，全部支持PDF免费下载打印，无需注册。适合8-9岁，按教材单元同步，家长辅导好帮手，课后巩固，配答案详解。',
  ...
  },
  {
    ...
    metaDescription: '专为小学四年级学生设计的免费学习资源。包含四年级大数的认识、三位数乘除法、平行四边形、梯形面积、小数加减法、英语句型、作文进阶500字等核心知识点练习卷，配套口算速练、单元测试卷、英语字帖等在线工具，全部支持PDF免费下载打印，无需注册。适合9-10岁，按教材单元同步，家长辅导好帮手，课后巩固复习必备。',
  ...
  },
  {
    ...
    metaDescription: '专为小学五年级学生设计的免费学习资源。包含五年级小数乘除法、简易方程、因数倍数、组合图形面积、英语时态、阅读理解、作文500字以上等核心练习卷，配套单元测试卷、口算速练、古诗词默写等在线工具，全部支持PDF免费下载打印，无需注册。适合10-11岁，小升初备考起步，配套小升初模拟卷，家长辅导好帮手，课后巩固必备。',
  ...
  },
  {
    ...
    metaDescription: '专为小学六年级学生设计的免费学习资源。包含六年级小升初数学总复习、百分数应用题、圆与圆柱、比例、英语语法、毕业作文600字等核心练习卷，配套单元测试卷、小升初模拟卷、古诗词默写等在线工具，全部支持PDF免费下载打印，无需注册。适合11-12岁，小升初冲刺必备，配套小升初模拟卷，家长辅导好帮手，课后巩固复习。',
