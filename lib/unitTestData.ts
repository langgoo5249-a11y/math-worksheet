...
,

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "在○里填上\">\"、\"<\"或\"=\"。\n7○5", answer: ">", difficulty: 1 },
      { type: "填空题", content: "在○里填上\">\"、\"<\"或\"=\"。\n3○6", answer: "<", difficulty: 1 },
      { type: "填空题", content: "在○里填上\">\"、\"<\"或\"=\"。\n8○8", answer: "=", difficulty: 1 },
      { type: "选择题", content: "下面哪个数最大？\nA. 4  B. 9  C. 6", answer: "B", difficulty: 1 },
      { type: "选择题", content: "下面哪个数最小？\nA. 2  B. 7  C. 5", answer: "A", difficulty: 1 },
      { type: "填空题", content: "把4、9、6从大到小排列：（ ）>（ ）>（ ）", answer: "9>6>4", difficulty: 2 },
      { type: "判断题", content: "5比3大。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "10比9小。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "比6大比9小的数有（ ）和（ ）。", answer: "7；8", difficulty: 2 },
      { type: "填空题", content: "在5、0、8、3中，最大的数是（ ），最小的数是（ ）。", answer: "8；0", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "3 + 4 - 2 =", answer: "5", difficulty: 1 },
      { type: "计算题", content: "8 - 5 + 3 =", answer: "6", difficulty: 1 },
      { type: "计算题", content: "9 - 3 - 4 =", answer: "2", difficulty: 1 },
      { type: "计算题", content: "2 + 5 + 1 =", answer: "8", difficulty: 1 },
      { type: "计算题", content: "10 - 4 + 2 =", answer: "8", difficulty: 2 },
      { type: "填空题", content: "（ ）+ 3 = 7", answer: "4", difficulty: 2 },
      { type: "填空题", content: "9 -（ ）= 4", answer: "5", difficulty: 2 },
      { type: "应用题", content: "树上有8只鸟，飞走了3只，又飞来了2只，现在树上有几只鸟？", answer: "8-3+2=7（只）", difficulty: 2 },
      { type: "应用题", content: "小明有5朵花，小红给了他3朵，他送给小华4朵，小明现在有几朵花？", answer: "5+3-4=4（朵）", difficulty: 2 },
      { type: "判断题", content: "6 + 2 - 3 = 4。（ ）", answer: "×", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "钟面上有（ ）个数字，从1到（ ）。", answer: "12；12", difficulty: 1 },
      { type: "填空题", content: "钟面上短针是（ ）针，长针是（ ）针。", answer: "时；分", difficulty: 1 },
      { type: "选择题", content: "时针指向3，分针指向12，这时是（ ）。\nA. 3点  B. 12点  C. 6点", answer: "A", difficulty: 1 },
      { type: "选择题", content: "时针指向6，分针指向12，这时是（ ）。\nA. 12点  B. 6点  C. 3点", answer: "B", difficulty: 1 },
      { type: "判断题", content: "时针走一圈是12小时。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "分针走一圈是1小时。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "时针从3走到5，经过了（ ）小时。", answer: "2", difficulty: 2 },
      { type: "填空题", content: "一天有（ ）小时。", answer: "24", difficulty: 2 },
      { type: "选择题", content: "上午上学的时间大约是（ ）。\nA. 7时  B. 12时  C. 9时", answer: "A", difficulty: 2 },
      { type: "应用题", content: "小明早上7时起床，8时到学校，他在路上用了多长时间？", answer: "8-7=1（小时）", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "长方形有（ ）条边，（ ）个角。", answer: "4；4", difficulty: 1 },
      { type: "填空题", content: "正方形有（ ）条边，每条边都（ ）。", answer: "4；相等", difficulty: 1 },
      { type: "选择题", content: "下面哪个是圆形？\nA. 课本的面  B. 硬币的面  C. 三角板", answer: "B", difficulty: 1 },
      { type: "选择题", content: "三角形有（ ）条边。\nA. 3  B. 4  C. 5", answer: "A", difficulty: 1 },
      { type: "判断题", content: "正方形是特殊的长方形。（ ）", answer: "√", difficulty: 2 },
      { type: "判断题", content: "所有的四边形都是正方形。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "用3根小棒可以拼成一个（ ）形。", answer: "三角", difficulty: 1 },
      { type: "填空题", content: "用4根一样长的小棒可以拼成一个（ ）形。", answer: "正方", difficulty: 1 },
      { type: "选择题", content: "下面图形中，不是四边形的是（ ）。\nA. 长方形  B. 正方形  C. 三角形", answer: "C", difficulty: 1 },
      { type: "填空题", content: "平行四边形有（ ）条边，（ ）个角。", answer: "4；4", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "25 + 13 =", answer: "38", difficulty: 1 },
      { type: "计算题", content: "47 - 23 =", answer: "24", difficulty: 1 },
      { type: "计算题", content: "56 + 24 =", answer: "80", difficulty: 1 },
      { type: "计算题", content: "90 - 35 =", answer: "55", difficulty: 2 },
      { type: "计算题", content: "38 + 45 - 20 =", answer: "63", difficulty: 2 },
      { type: "填空题", content: "（ ）+ 30 = 65", answer: "35", difficulty: 2 },
      { type: "填空题", content: "82 -（ ）= 47", answer: "35", difficulty: 2 },
      { type: "应用题", content: "商店有45个苹果，卖出18个，又进了30个，现在有多少个苹果？", answer: "45-18+30=57（个）", difficulty: 2 },
      { type: "应用题", content: "一年级有36人参加春游，二年级有28人参加，两个年级一共有多少人？", answer: "36+28=64（人）", difficulty: 2 },
      { type: "选择题", content: "下面哪个算式的得数最大？\nA. 34+21  B. 45+12  C. 23+34", answer: "C", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "1米 =（ ）厘米", answer: "100", difficulty: 1 },
      { type: "填空题", content: "200厘米 =（ ）米", answer: "2", difficulty: 1 },
      { type: "选择题", content: "一棵大树高约（ ）。\nA. 5厘米  B. 5米  C. 50米", answer: "B", difficulty: 1 },
      { type: "选择题", content: "一支铅笔长约（ ）。\nA. 15厘米  B. 15米  C. 50厘米", answer: "A", difficulty: 1 },
      { type: "判断题", content: "1米比100厘米短。（ ）", answer: "×", difficulty: 1 },
      { type: "判断题", content: "教室的长大约是8米。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "3米 =（ ）厘米", answer: "300", difficulty: 1 },
      { type: "填空题", content: "500厘米 =（ ）米", answer: "5", difficulty: 1 },
      { type: "应用题", content: "小明身高125厘米，小华身高1米30厘米，谁更高？高多少？", answer: "小华更高，高5厘米", difficulty: 2 },
      { type: "填空题", content: "在○里填上\">\"、\"<\"或\"=\"。\n4米○40厘米", answer: ">", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "3 × 4 + 2 =", answer: "14", difficulty: 1 },
      { type: "计算题", content: "5 × 3 - 4 =", answer: "11", difficulty: 2 },
      { type: "计算题", content: "2 × 6 + 5 =", answer: "17", difficulty: 1 },
      { type: "计算题", content: "4 × 4 - 3 =", answer: "13", difficulty: 2 },
      { type: "填空题", content: "3个4再加5，列式为（ ）。", answer: "3×4+5=17", difficulty: 2 },
      { type: "填空题", content: "5个3减去7，列式为（ ）。", answer: "5×3-7=8", difficulty: 2 },
      { type: "应用题", content: "每个篮子装4个苹果，有3个篮子，妈妈又买了5个，一共有多少个苹果？", answer: "3×4+5=17（个）", difficulty: 2 },
      { type: "应用题", content: "小明买了4包糖，每包5颗，吃了8颗，还剩多少颗？", answer: "4×5-8=12（颗）", difficulty: 2 },
      { type: "选择题", content: "2 × 5 + 3 =（ ）\nA. 10  B. 13  C. 7", answer: "B", difficulty: 1 },
      { type: "判断题", content: "3 × 3 + 3 = 3 × 4。（ ）", answer: "√", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "17 ÷ 3 =（ ）……（ ）", answer: "5……2", difficulty: 1 },
      { type: "计算题", content: "20 ÷ 4 =（ ）……（ ）", answer: "5……0", difficulty: 1 },
      { type: "计算题", content: "25 ÷ 6 =（ ）……（ ）", answer: "4……1", difficulty: 2 },
      { type: "计算题", content: "30 ÷ 7 =（ ）……（ ）", answer: "4……2", difficulty: 2 },
      { type: "填空题", content: "在有余数的除法中，余数一定要比除数（ ）。", answer: "小", difficulty: 1 },
      { type: "判断题", content: "22 ÷ 5 = 3……7。（ ）", answer: "×", difficulty: 2 },
      { type: "判断题", content: "19 ÷ 4 = 4……3。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "有23个苹果，平均放在4个盘子里，每个盘子放几个？还剩几个？", answer: "23÷4=5（个）……3（个）", difficulty: 2 },
      { type: "应用题", content: "有35颗糖，每袋装6颗，可以装几袋？还剩几颗？", answer: "35÷6=5（袋）……5（颗）", difficulty: 2 },
      { type: "选择题", content: "下面哪个算式的余数是2？\nA. 15÷3  B. 20÷6  C. 18÷4", answer: "B", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "(15 + 20) ÷ 5 =", answer: "7", difficulty: 2 },
      { type: "计算题", content: "6 × (10 - 4) =", answer: "36", difficulty: 2 },
      { type: "计算题", content: "45 - 18 + 12 =", answer: "39", difficulty: 1 },
      { type: "计算题", content: "(30 - 6) ÷ 8 =", answer: "3", difficulty: 2 },
      { type: "计算题", content: "4 × 5 + 3 × 2 =", answer: "26", difficulty: 2 },
      { type: "填空题", content: "计算(8+4)×3时，要先算（ ）法。", answer: "括号里面的加", difficulty: 2 },
      { type: "选择题", content: "下面哪个算式先算加法？\nA. 6+3×2  B. (6+3)×2  C. 6×3+2", answer: "B", difficulty: 2 },
      { type: "判断题", content: "8+2×3 = (8+2)×3。（ ）", answer: "×", difficulty: 2 },
      { type: "应用题", content: "小明买了3本书，每本8元，又买了1个5元的笔记本，一共花了多少元？", answer: "3×8+5=29（元）", difficulty: 2 },
      { type: "应用题", content: "有24个橘子，平均分给4个小朋友，每人分到几个？", answer: "24÷4=6（个）", difficulty: 1 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "1时 =（ ）分", answer: "60", difficulty: 1 },
      { type: "填空题", content: "1分 =（ ）秒", answer: "60", difficulty: 1 },
      { type: "填空题", content: "钟面上时针走一大格是（ ）时，分针走一小格是（ ）分。", answer: "1；1", difficulty: 1 },
      { type: "选择题", content: "分针从数字3走到数字6，经过了（ ）分。\nA. 3  B. 15  C. 30", answer: "B", difficulty: 2 },
      { type: "选择题", content: "时针从数字2走到数字5，经过了（ ）时。\nA. 3  B. 7  C. 10", answer: "A", difficulty: 1 },
      { type: "判断题", content: "秒针走一圈是1分钟。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "时针走一圈是12小时。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "2时30分 =（ ）分", answer: "150", difficulty: 2 },
      { type: "应用题", content: "一节课40分钟，课间休息10分钟，第二节课9:00上课，第一节课什么时间开始？", answer: "8:10", difficulty: 3 },
      { type: "填空题", content: "小明跑60米用了12秒，小华用了15秒，（ ）跑得快。", answer: "小明", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "把一个圆平均分成4份，每份是它的（ ）分之一。", answer: "四", difficulty: 1 },
      { type: "填空题", content: "二分之一写作（ ），三分之一写作（ ）。", answer: "1/2；1/3", difficulty: 1 },
      { type: "选择题", content: "下面哪个分数最大？\nA. 1/2  B. 1/3  C. 1/4", answer: "A", difficulty: 2 },
      { type: "选择题", content: "把一个蛋糕平均分成8份，吃了3份，吃了这个蛋糕的（ ）。\nA. 3/8  B. 8/3  C. 1/8", answer: "A", difficulty: 2 },
      { type: "判断题", content: "1/4就是把一个物体分成4份，取其中的1份。（ ）", answer: "×", difficulty: 2 },
      { type: "判断题", content: "分子相同的分数，分母越大分数越小。（ ）", answer: "√", difficulty: 3 },
      { type: "填空题", content: "3/5里面有（ ）个1/5。", answer: "3", difficulty: 1 },
      { type: "填空题", content: "1 =（ ）/（ ）（填一个答案即可）", answer: "2/2（答案不唯一）", difficulty: 2 },
      { type: "选择题", content: "同样大小的两个披萨，小明吃了第一个的1/2，小红吃了第二个的1/3，（ ）吃得多。", answer: "A", difficulty: 2 },
      { type: "应用题", content: "一根绳子长12米，剪下它的1/3，剪下了多少米？", answer: "12÷3=4（米）", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "早晨起来，面向太阳，前面是（ ），后面是（ ），左面是（ ），右面是（ ）。", answer: "东；西；北；南", difficulty: 1 },
      { type: "填空题", content: "地图通常是按上（ ）、下（ ）、左（ ）、右（ ）绘制的。", answer: "北；南；西；东", difficulty: 1 },
      { type: "选择题", content: "小明的家在学校的东面，学校在小明家的（ ）面。\nA. 东  B. 西  C. 南", answer: "B", difficulty: 2 },
      { type: "选择题", content: "面向北，右面是（ ）。\nA. 东  B. 西  C. 南", answer: "A", difficulty: 1 },
      { type: "判断题", content: "东南方向在东和南之间。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "面向南，左边是东。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "面向西，后面是（ ），左面是（ ），右面是（ ）。", answer: "东；南；北", difficulty: 2 },
      { type: "应用题", content: "小明从家出发，先向东走200米到学校，再向北走150米到图书馆。从图书馆回最近的路线怎么走？", answer: "先向南走150米到学校，再向西走200米到家", difficulty: 3 },
      { type: "选择题", content: "东北方向在（ ）和（ ）之间。\nA. 东和北  B. 东和南  C. 西和北", answer: "A", difficulty: 1 },
      { type: "填空题", content: "与东北相对的方向是（ ）。", answer: "西南", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "长方形的面积 =（ ）×（ ）", answer: "长；宽", difficulty: 1 },
      { type: "填空题", content: "正方形的面积 =（ ）×（ ）", answer: "边长；边长", difficulty: 1 },
      { type: "计算题", content: "一个长方形长8厘米，宽5厘米，面积是多少？", answer: "8×5=40（平方厘米）", difficulty: 1 },
      { type: "计算题", content: "一个正方形边长6分米，面积是多少？", answer: "6×6=36（平方分米）", difficulty: 1 },
      { type: "填空题", content: "1平方米 =（ ）平方分米", answer: "100", difficulty: 1 },
      { type: "填空题", content: "1平方分米 =（ ）平方厘米", answer: "100", difficulty: 1 },
      { type: "选择题", content: "一个长方形长10米，宽6米，周长是（ ）米。\nA. 60  B. 32  C. 16", answer: "B", difficulty: 2 },
      { type: "应用题", content: "一个长方形花坛长12米，宽8米，如果在花坛四周围一圈栅栏，需要多长的栅栏？", answer: "(12+8)×2=40（米）", difficulty: 2 },
      { type: "应用题", content: "一间教室长9米，宽6米，如果用边长3分米的方砖铺地，需要多少块？", answer: "9×6=54平方米=5400平方分米，5400÷(3×3)=600块", difficulty: 3 },
      { type: "判断题", content: "面积相等的长方形，周长也一定相等。（ ）", answer: "×", difficulty: 3 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "平行四边形有（ ）组对边分别平行。", answer: "两", difficulty: 1 },
      { type: "填空题", content: "梯形只有（ ）组对边平行。", answer: "一", difficulty: 1 },
      { type: "选择题", content: "下面哪个图形是梯形？\nA. 长方形  B. 正方形  C. 只有一组对边平行的四边形", answer: "C", difficulty: 1 },
      { type: "判断题", content: "平行四边形的对角相等。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "梯形的四个角可以都是直角。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "两个完全一样的梯形可以拼成一个（ ）。", answer: "平行四边形", difficulty: 2 },
      { type: "选择题", content: "平行四边形的内角和是（ ）度。\nA. 180  B. 360  C. 540", answer: "B", difficulty: 2 },
      { type: "填空题", content: "直角梯形中有（ ）个直角。", answer: "两", difficulty: 1 },
      { type: "判断题", content: "长方形是特殊的平行四边形。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "等腰梯形的两腰（ ）。", answer: "相等", difficulty: 1 }
    ],
  },

  {
    ...
    questions: [
      ...
      { type: "填空题", content: "1平方千米 =（ ）公顷", answer: "100", difficulty: 1 },
      { type: "填空题", content: "1平方千米 =（ ）平方米", answer: "1000000", difficulty: 2 },
      { type: "选择题", content: "一个足球场的面积约1（ ）。\nA. 平方米  B. 公顷  C. 平方千米", answer: "B", difficulty: 2 },
      { type: "选择题", content: "北京市的面积约16410（ ）。\nA. 公顷  B. 平方千米  C. 平方米", answer: "B", difficulty: 2 },
      { type: "判断题", content: "1公顷比1平方千米大。（ ）", answer: "×", difficulty: 1 },
      { type: "判断题", content: "教室的面积约50平方米。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "5公顷 =（ ）平方米", answer: "50000", difficulty: 1 },
      { type: "填空题", content: "300公顷 =（ ）平方千米", answer: "3", difficulty: 1 },
      { type: "应用题", content: "一块长方形土地长500米，宽200米，这块土地的面积是多少公顷？", answer: "500×200=100000平方米=10公顷", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "0.35的计数单位是（ ），它有（ ）个这样的单位。", answer: "0.01；35", difficulty: 2 },
      { type: "填空题", content: "把3.6的小数点向右移动两位是（ ）。", answer: "360", difficulty: 1 },
      { type: "填空题", content: "把25缩小到原来的1/100是（ ）。", answer: "0.25", difficulty: 1 },
      { type: "选择题", content: "下面哪个小数与0.8相等？\nA. 0.08  B. 0.80  C. 8.0", answer: "B", difficulty: 1 },
      { type: "选择题", content: "5.03中的\"3\"在（ ）位。\nA. 个  B. 十分  C. 百分", answer: "C", difficulty: 1 },
      { type: "判断题", content: "小数点的末尾添上0或去掉0，小数的大小不变。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "0.4和0.40的大小相等，计数单位也相同。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "把0.368保留两位小数约是（ ）。", answer: "0.37", difficulty: 2 },
      { type: "填空题", content: "把5.947保留一位小数约是（ ）。", answer: "5.9", difficulty: 2 },
      { type: "应用题", content: "1千克苹果5.80元，买3千克需要多少元？", answer: "5.80×3=17.40元", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "三角形的内角和是（ ）度。", answer: "180", difficulty: 1 },
      { type: "选择题", content: "一个三角形中，两个角分别是50度和70度，第三个角是（ ）度。\nA. 50  B. 60  C. 70", answer: "B", difficulty: 2 },
      { type: "判断题", content: "一个三角形中最多有一个直角。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "等边三角形一定是锐角三角形。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "等腰三角形的两条（ ）相等。", answer: "腰", difficulty: 1 },
      { type: "选择题", content: "下面哪组线段可以围成三角形？\nA. 2cm 3cm 6cm  B. 3cm 4cm 5cm  C. 1cm 2cm 5cm", answer: "B", difficulty: 2 },
      { type: "填空题", content: "一个等边三角形的每条边长8厘米，它的周长是（ ）厘米。", answer: "24", difficulty: 1 },
      { type: "填空题", content: "一个直角三角形中，一个锐角是35度，另一个锐角是（ ）度。", answer: "55", difficulty: 2 },
      { type: "判断题", content: "三角形具有稳定性。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "一个等腰三角形的周长是30厘米，底边长10厘米，一条腰长多少厘米？", answer: "(30-10)÷2=10厘米", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "2.5 × 0.4 =", answer: "1.0", difficulty: 1 },
      { type: "计算题", content: "3.6 × 1.5 =", answer: "5.4", difficulty: 2 },
      { type: "计算题", content: "0.25 × 4 =", answer: "1", difficulty: 1 },
      { type: "计算题", content: "1.2 × 3.5 =", answer: "4.2", difficulty: 2 },
      { type: "填空题", content: "2.3 × 0.5的积有（ ）位小数。", answer: "两", difficulty: 1 },
      { type: "选择题", content: "0.8 × 0.9 =（ ）\nA. 7.2  B. 0.72  C. 0.072", answer: "B", difficulty: 2 },
      { type: "判断题", content: "一个数乘以小数，积一定比这个数小。（ ）", answer: "×", difficulty: 2 },
      { type: "应用题", content: "苹果每千克4.5元，买2.4千克需要多少元？", answer: "4.5×2.4=10.8元", difficulty: 2 },
      { type: "应用题", content: "一块长方形地长3.5米，宽2.4米，面积是多少平方米？", answer: "3.5×2.4=8.4平方米", difficulty: 2 },
      { type: "填空题", content: "3.6 × 0.2 = 3.6 ÷（ ）", answer: "5", difficulty: 3 }
    ],
  },

  {
    ...
    questions: [
      ...
      { type: "计算题", content: "5.6 ÷ 0.04 =", answer: "140", difficulty: 2 },
      { type: "计算题", content: "3.6 ÷ 1.2 =", answer: "3", difficulty: 1 },
      { type: "计算题", content: "0.72 ÷ 0.9 =", answer: "0.8", difficulty: 2 },
      { type: "填空题", content: "6.5 ÷ 0.5 =（ ）", answer: "13", difficulty: 1 },
      { type: "选择题", content: "10 ÷ 0.25 =（ ）\nA. 4  B. 40  C. 2.5", answer: "B", difficulty: 2 },
      { type: "判断题", content: "一个数除以0.1，等于这个数乘以10。（ ）", answer: "√", difficulty: 2 },
      { type: "应用题", content: "妈妈用15.6元买了3千克西红柿，每千克西红柿多少元？", answer: "15.6÷3=5.2元", difficulty: 2 },
      { type: "应用题", content: "小明买了4支钢笔，共花了21.6元，每支钢笔多少元？", answer: "21.6÷4=5.4元", difficulty: 2 },
      { type: "填空题", content: "把3.6扩大100倍是（ ），再把结果缩小10倍是（ ）。", answer: "360；36", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "解方程", content: "2x + 5 = 17", answer: "x = 6", difficulty: 2 },
      { type: "解方程", content: "3x - 8 = 13", answer: "x = 7", difficulty: 2 },
      { type: "解方程", content: "4x = 36", answer: "x = 9", difficulty: 1 },
      { type: "解方程", content: "x ÷ 5 = 8", answer: "x = 40", difficulty: 1 },
      { type: "解方程", content: "2(x + 3) = 18", answer: "x = 6", difficulty: 3 },
      { type: "解方程", content: "5x - 2x = 15", answer: "x = 5", difficulty: 2 },
      { type: "应用题", content: "小明买了3本笔记本，每本x元，付了20元，找回2元。列出方程并求解。", answer: "3x+2=20，x=6", difficulty: 2 },
      { type: "应用题", content: "一个长方形周长是30厘米，长是x厘米，宽是8厘米。列出方程并求x。", answer: "2(x+8)=30，x=7", difficulty: 3 },
      { type: "选择题", content: "x = 3是下面哪个方程的解？\nA. 2x + 1 = 5  B. 3x - 1 = 8  C. x + 5 = 10", answer: "A", difficulty: 2 },
      { type: "判断题", content: "含有未知数的等式叫做方程。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    questions: [
      { type: "计算题", content: "1/2 + 1/3 =", answer: "5/6", difficulty: 2 },
      { type: "计算题", content: "3/4 - 1/6 =", answer: "7/12", difficulty: 2 },
      { type: "计算题", content: "5/8 + 1/4 =", answer: "7/8", difficulty: 2 },
      { type: "计算题", content: "7/10 - 2/5 =", answer: "3/10", difficulty: 2 },
      { type: "计算题", content: "2/3 + 1/6 - 1/4 =", answer: "9/12=3/4", difficulty: 3 },
      { type: "填空题", content: "1/2 +（ ）= 5/6", answer: "1/3", difficulty: 2 },
      { type: "选择题", content: "下面哪个计算是正确的？\nA. 1/2+1/3=2/5  B. 1/2+1/3=5/6  C. 1/2+1/3=1/5", answer: "B", difficulty: 2 },
      { type: "判断题", content: "分数单位不同的分数不能直接相加减。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "一根铁丝，第一次用去全长的1/4，第二次用去全长的1/3，两次一共用去全长的几分之几？", answer: "1/4+1/3=7/12", difficulty: 2 },
      { type: "应用题", content: "一块地，种白菜占2/5，种萝卜占1/4，剩下的种青菜，种青菜占几分之几？", answer: "1-2/5-1/4=7/20", difficulty: 3 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "长方体的体积 =（ ）×（ ）×（ ）", answer: "长；宽；高", difficulty: 1 },
      { type: "填空题", content: "正方体的体积 =（ ）×（ ）×（ ）", answer: "边长；边长；边长", difficulty: 1 },
      { type: "填空题", content: "1立方分米 =（ ）立方厘米", answer: "1000", difficulty: 1 },
      { type: "填空题", content: "1立方米 =（ ）立方分米", answer: "1000", difficulty: 1 },
      { type: "计算题", content: "一个长方体长5厘米，宽3厘米，高4厘米，体积是多少？", answer: "5×3×4=60立方厘米", difficulty: 1 },
      { type: "计算题", content: "一个正方体棱长4分米，体积是多少？", answer: "4×4×4=64立方分米", difficulty: 1 },
      { type: "选择题", content: "一个冰箱的体积大约是（ ）。\nA. 1立方厘米  B. 1立方分米  C. 1立方米", answer: "C", difficulty: 2 },
      { type: "应用题", content: "一个长方体水箱长6分米，宽4分米，高5分米，这个水箱能装多少升水？", answer: "6×4×5=120立方分米=120升", difficulty: 2 },
      { type: "判断题", content: "体积相等的两个长方体，形状一定相同。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "容积的计算方法和体积（ ），但要从（ ）量长、宽、高。", answer: "相同；里面", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "应用题", content: "一个水池长8米，宽6米，深2米。这个水池最多能装多少立方米的水？", answer: "8×6×2=96立方米", difficulty: 2 },
      { type: "应用题", content: "一根长方体木料长2米，截面是边长0.3米的正方形。这根木料的体积是多少立方米？", answer: "2×0.3×0.3=0.18立方米", difficulty: 2 },
      { type: "应用题", content: "一个房间长5米，宽4米，高3米。要粉刷四周墙壁和天花板（门窗面积共10平方米），粉刷面积是多少？", answer: "5×4+(5×3+4×3)×2-10=64平方米", difficulty: 3 },
      { type: "应用题", content: "一个正方体纸箱棱长0.5米，它的体积是多少立方分米？", answer: "0.5×0.5×0.5=0.125立方米=125立方分米", difficulty: 2 },
      { type: "计算题", content: "3/4 + 2/5 - 1/10 =", answer: "21/20", difficulty: 3 },
      { type: "解方程", content: "2x + 3x = 25", answer: "x = 5", difficulty: 2 },
      { type: "应用题", content: "果园里有苹果树和梨树共120棵，苹果树是梨树的3倍，苹果树和梨树各有多少棵？", answer: "梨树：120÷(3+1)=30棵，苹果树：30×3=90棵", difficulty: 3 },
      { type: "应用题", content: "修一条路，第一天修了全长的1/5，第二天修了全长的1/4，还剩全长的几分之几没修？", answer: "1-1/5-1/4=11/20", difficulty: 2 },
      { type: "选择题", content: "一个长方体的长扩大2倍，宽和高不变，体积扩大（ ）倍。\nA. 2  B. 4  C. 8", answer: "A", difficulty: 2 },
      { type: "填空题", content: "5个1/8是（ ），再加上3个1/8是（ ）。", answer: "5/8；1", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "圆的周长 =（ ）×（ ）或（ ）× 2 ×（ ）", answer: "π；直径；π；半径", difficulty: 1 },
      { type: "填空题", content: "圆的面积 =（ ）×（ ）× π", answer: "半径；半径", difficulty: 1 },
      { type: "计算题", content: "一个圆的半径是3厘米，面积是多少？（π取3.14）", answer: "3.14×3×3=28.26平方厘米", difficulty: 2 },
      { type: "计算题", content: "一个圆的直径是8分米，周长是多少？（π取3.14）", answer: "3.14×8=25.12分米", difficulty: 1 },
      { type: "选择题", content: "一个圆的半径扩大2倍，面积扩大（ ）倍。\nA. 2  B. 4  C. 8", answer: "B", difficulty: 2 },
      { type: "判断题", content: "π是一个无限不循环小数。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "一个圆形花坛的直径是10米，它的面积是多少平方米？（π取3.14）", answer: "3.14×(10÷2)×(10÷2)=78.5平方米", difficulty: 2 },
      { type: "应用题", content: "一个圆形水池的周长是31.4米，它的半径是多少米？（π取3.14）", answer: "31.4÷3.14÷2=5米", difficulty: 2 },
      { type: "填空题", content: "一个半圆的直径是6厘米，它的周长是（ ）厘米。（π取3.14）", answer: "3.14×6÷2+6=15.42", difficulty: 3 },
      { type: "判断题", content: "两个圆的周长相等，面积也一定相等。（ ）", answer: "√", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "45%读作（ ），百分之三十五写作（ ）。", answer: "百分之四十五；35%", difficulty: 1 },
      { type: "填空题", content: "3/5 =（ ）% =（ ）÷（ ）=（ ）（填小数）", answer: "60；3；5；0.6", difficulty: 2 },
      { type: "选择题", content: "下面哪个数最大？\nA. 0.45  B. 4/9  C. 45%", answer: "A", difficulty: 2 },
      { type: "计算题", content: "250的40%是多少？", answer: "250×40%=100", difficulty: 1 },
      { type: "计算题", content: "一个数的30%是60，这个数是多少？", answer: "60÷30%=200", difficulty: 2 },
      { type: "应用题", content: "一件商品原价200元，打八折出售，现价多少元？", answer: "200×80%=160元", difficulty: 2 },
      { type: "应用题", content: "小明存了500元，年利率是2%，一年后利息是多少元？", answer: "500×2%=10元", difficulty: 2 },
      { type: "判断题", content: "百分数的分子一定小于100。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "出勤率 =（ ）÷（ ）× 100%", answer: "出勤人数；总人数", difficulty: 1 },
      { type: "应用题", content: "六年级有200人，今天有4人请假，今天的出勤率是多少？", answer: "(200-4)÷200×100%=98%", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "常用的统计图有（ ）统计图、（ ）统计图和（ ）统计图。", answer: "条形；折线；扇形", difficulty: 1 },
      { type: "选择题", content: "要反映数量的增减变化情况，最好用（ ）统计图。\nA. 条形  B. 折线  C. 扇形", answer: "B", difficulty: 1 },
      { type: "选择题", content: "要反映各部分占总体的百分比，最好用（ ）统计图。\nA. 条形  B. 折线  C. 扇形", answer: "C", difficulty: 1 },
      { type: "填空题", content: "扇形统计图中，所有扇形的百分比之和是（ ）。", answer: "100%", difficulty: 1 },
      { type: "判断题", content: "条形统计图可以清楚地看出各数量的多少。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "六（1）班有40人，参加各类兴趣小组的人数占总人数的百分比如下：体育30%，美术25%，音乐20%，科技25%。参加体育组的有多少人？", answer: "40×30%=12人", difficulty: 2 },
      { type: "填空题", content: "在一组数据中，出现次数最多的数叫做（ ）。", answer: "众数", difficulty: 2 },
      { type: "填空题", content: "一组数据从小到大排列，最中间的数叫做（ ）。", answer: "中位数", difficulty: 2 },
      { type: "判断题", content: "在一组数据中，平均数一定大于中位数。（ ）", answer: "×", difficulty: 2 },
      { type: "应用题", content: "五个同学的身高是145cm、150cm、148cm、152cm、155cm，这组数据的中位数是多少？", answer: "150cm", difficulty: 2 }
    ],
  },

  {
    ...
    questions: [
      { type: "填空题", content: "圆柱的体积 =（ ）×（ ）", answer: "底面积；高", difficulty: 1 },
      { type: "填空题", content: "圆锥的体积 =（ ）×（ ）÷（ ）", answer: "底面积；高；3", difficulty: 1 },
      { type: "计算题", content: "一个圆柱底面半径是2厘米，高5厘米，体积是多少？（π取3.14）", answer: "3.14×2×2×5=62.8立方厘米", difficulty: 2 },
      { type: "计算题", content: "一个圆锥底面积是12平方厘米，高6厘米，体积是多少？", answer: "12×6÷3=24立方厘米", difficulty: 2 },
      { type: "选择题", content: "一个圆柱和一个圆锥等底等高，圆锥的体积是圆柱体积的（ ）。\nA. 1/2  B. 1/3  C. 2/3", answer: "B", difficulty: 1 },
      { type: "判断题", content: "圆柱的侧面展开是一个长方形。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "一个圆柱形水桶底面直径是20厘米，高25厘米，这个水桶能装多少升水？（π取3.14）", answer: "3.14×(20÷2)×(20÷2)×25=7850立方厘米=7.85升", difficulty: 3 },
      { type: "应用题", content: "一个圆锥形沙堆底面周长是12.56米，高1.5米，这堆沙的体积是多少立方米？（π取3.14）", answer: "底面半径：12.56÷3.14÷2=2米，体积：3.14×2×2×1.5÷3=6.28立方米", difficulty: 3 },
      { type: "填空题", content: "圆柱的侧面积 =（ ）×（ ）", answer: "底面周长；高", difficulty: 1 },
      { type: "判断题", content: "圆锥的体积等于圆柱体积的1/3。（ ）", answer: "×", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "两种相关联的量，如果相对应的两个数的（ ）一定，这两种量就叫做成正比例的量。", answer: "比值", difficulty: 1 },
      { type: "填空题", content: "如果两种量中相对应的两个数的（ ）一定，这两种量就叫做成反比例的量。", answer: "乘积", difficulty: 1 },
      { type: "选择题", content: "下面哪组量成正比例？\nA. 速度一定，路程和时间  B. 路程一定，速度和时间  C. 单价一定，总价和数量", answer: "A和C", difficulty: 2 },
      { type: "选择题", content: "下面哪组量成反比例？\nA. 单价一定，总价和数量  B. 总价一定，单价和数量  C. 数量一定，单价和总价", answer: "B", difficulty: 2 },
      { type: "判断题", content: "圆的面积和半径成正比例。（ ）", answer: "×", difficulty: 2 },
      { type: "判断题", content: "圆的周长和直径成正比例。（ ）", answer: "√", difficulty: 1 },
      { type: "判断题", content: "工作总量一定，工作效率和工作时间成反比例。（ ）", answer: "√", difficulty: 1 },
      { type: "应用题", content: "小明以每小时5千米的速度行走，2小时走了10千米。如果速度变为每小时4千米，走10千米需要几小时？", answer: "路程一定，速度和时间成反比例。5×2=4×x，x=2.5小时", difficulty: 3 },
      { type: "填空题", content: "y/x = k（一定），则y和x成（ ）比例。", answer: "正", difficulty: 1 },
      { type: "填空题", content: "x × y = k（一定），则x和y成（ ）比例。", answer: "反", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "计算题", content: "3/4 ÷ 3/8 =", answer: "2", difficulty: 1 },
      { type: "计算题", content: "2.5 × 0.4 + 1.5 =", answer: "2.5", difficulty: 2 },
      { type: "解方程", content: "x/3 + x/4 = 7", answer: "x = 12", difficulty: 3 },
      { type: "填空题", content: "一个圆的周长是18.84厘米，它的面积是（ ）平方厘米。（π取3.14）", answer: "28.26", difficulty: 2 },
      { type: "选择题", content: "把20克盐溶解在100克水中，盐占盐水的（ ）。\nA. 20%  B. 16.7%  C. 25%", answer: "B", difficulty: 3 },
      { type: "应用题", content: "一个圆柱形水池，底面半径2米，深1.5米。在水池的底面和四周抹上水泥，抹水泥的面积是多少？（π取3.14）", answer: "底面积：3.14×2×2=12.56平方米，侧面积：3.14×2×2×1.5=18.84平方米，总面积：12.56+18.84=31.4平方米", difficulty: 3 },
      { type: "判断题", content: "所有的质数都是奇数。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "一个数的3/5是24，这个数是（ ）。", answer: "40", difficulty: 1 },
      { type: "应用题", content: "一批货物，第一天运走了30%，第二天运走了40%，还剩60吨。这批货物共有多少吨？", answer: "60÷(1-30%-40%)=200吨", difficulty: 3 },
      { type: "填空题", content: "把3.14、π、22/7从小到大排列：（ ）<（ ）<（ ）", answer: "3.14；π；22/7", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "对韵歌中\"云对（ ），雪对（ ）\"。\n请填空。", answer: "雨；风", difficulty: 1 },
      { type: "填空题", content: "\"花对（ ），鸟对（ ）\"。\n请填空。", answer: "树；虫", difficulty: 1 },
      { type: "选择题", content: "对韵歌中\"山清对水秀\"的下一句是（ ）。\nA. 柳绿对桃红  B. 鸟语对花香  C. 春暖对秋凉", answer: "A", difficulty: 1 },
      { type: "判断题", content: "对韵歌是一种对仗工整的韵文。（ ）", answer: "√", difficulty: 1 },
      { type: "连线题", content: "请连线：山清 —— 柳绿，水秀 —— 桃红", answer: "山清对水秀，柳绿对桃红", difficulty: 1 },
      { type: "填空题", content: "对韵歌中，\"清\"的反义词是（ ）。（从课文中找）", answer: "浊", difficulty: 2 },
      { type: "选择题", content: "\"云对雨\"中，\"云\"和\"雨\"都是自然现象，它们是（ ）。\nA. 反义词  B. 同类事物  C. 没有关系", answer: "B", difficulty: 1 },
      { type: "背诵题", content: "请背诵对韵歌全文。", answer: "云对雨，雪对风，花对树，鸟对虫。山清对水秀，柳绿对桃红。", difficulty: 2 },
      { type: "填空题", content: "\"柳绿对桃红\"中，\"柳\"和\"桃\"都是（ ）。", answer: "植物", difficulty: 1 },
      { type: "判断题", content: "对韵歌每句字数相同。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文中，大雨点问小雨点：\"你要到哪里去？\"\n小雨点说：\"我要去（ ）。\"", answer: "有花有草的地方", difficulty: 1 },
      { type: "填空题", content: "大雨点要去（ ）的地方。", answer: "没有花没有草", difficulty: 1 },
      { type: "选择题", content: "大雨点去了之后，那里发生了什么变化？（ ）\nA. 花更红了，草更绿了  B. 开出了红的花，长出了绿的草  C. 什么变化也没有", answer: "B", difficulty: 1 },
      { type: "判断题", content: "小雨点去了没有花没有草的地方。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "课文中用了（ ）和（ ）的对话来展开故事。", answer: "大雨点；小雨点", difficulty: 1 },
      { type: "选择题", content: "\"花更红了，草更绿了\"说明（ ）。\nA. 小雨点的作用  B. 大雨点的作用  C. 风的作用", answer: "A", difficulty: 2 },
      { type: "填空题", content: "\"数不清的雨点儿\"中\"数不清\"说明雨点儿（ ）。", answer: "非常多", difficulty: 1 },
      { type: "判断题", content: "雨点儿从云彩里飘落下来。（ ）", answer: "√", difficulty: 1 },
      { type: "选择题", content: "课文告诉我们雨水对植物（ ）。\nA. 没有用  B. 很有用  C. 有害", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我知道了雨水能让植物（ ）。", answer: "生长", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文中，\"我\"翻过来，（ ）睡不着。", answer: "唉", difficulty: 1 },
      { type: "填空题", content: "\"我\"翻过去，（ ）睡不着。", answer: "唉", difficulty: 1 },
      { type: "选择题", content: "\"我\"为什么睡不着？（ ）\nA. 因为生病了  B. 因为明天要远足  C. 因为害怕", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"我\"对明天的远足感到很期待。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "\"那地方的海，真的像老师说的，（ ）那么多种颜色吗？\"", answer: "那么蓝", difficulty: 1 },
      { type: "选择题", content: "课文中\"翻过来\"\"翻过去\"说明\"我\"（ ）。\nA. 在做运动  B. 很兴奋睡不着  C. 很困", answer: "B", difficulty: 2 },
      { type: "填空题", content: "\"远足\"的意思是（ ）。", answer: "到比较远的地方去游玩", difficulty: 1 },
      { type: "判断题", content: "这篇课文表达了小朋友对远足的期待和兴奋。（ ）", answer: "√", difficulty: 1 },
      { type: "选择题", content: "课文用了什么手法来表现\"我\"的心情？（ ）\nA. 写景  B. 反复  C. 夸张", answer: "B", difficulty: 2 },
      { type: "填空题", content: "课文中反复出现\"（ ）\"，表现了小朋友急切的心情。", answer: "唉", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文说，一个人玩，（ ）。", answer: "很好", difficulty: 1 },
      { type: "填空题", content: "两个人玩，（ ）。", answer: "真好", difficulty: 1 },
      { type: "选择题", content: "三个人玩，（ ）。\nA. 很好  B. 真好  C. 更好玩", answer: "C", difficulty: 1 },
      { type: "填空题", content: "课文中，一个人可以（ ）、折纸船、（ ）等。", answer: "画画；看图书", difficulty: 1 },
      { type: "判断题", content: "课文告诉我们只有很多人一起玩才快乐。（ ）", answer: "×", difficulty: 1 },
      { type: "选择题", content: "\"怎么都快乐\"的意思是（ ）。\nA. 只有一个人快乐  B. 不管几个人玩都快乐  C. 不快乐", answer: "B", difficulty: 1 },
      { type: "填空题", content: "四个人玩，可以（ ）。", answer: "捉迷藏", difficulty: 1 },
      { type: "判断题", content: "课文用了排比的写法。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "许多人玩，可以（ ）、（ ）等。", answer: "拔河；打排球", difficulty: 1 },
      { type: "选择题", content: "这篇课文告诉我们的道理是（ ）。\nA. 游戏很重要  B. 不管怎样玩都能找到快乐  C. 只有集体活动才好", answer: "B", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文中，（ ）的铅笔找不到了。", answer: "贝贝", difficulty: 1 },
      { type: "填空题", content: "妈妈告诉贝贝，要让文具回到（ ）。", answer: "自己的家", difficulty: 1 },
      { type: "选择题", content: "铅笔的\"家\"是（ ）。\nA. 垃圾桶  B. 铅笔盒  C. 书包", answer: "B", difficulty: 1 },
      { type: "判断题", content: "贝贝一开始很爱护文具。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "课文告诉我们，要（ ）自己的文具。", answer: "爱护", difficulty: 1 },
      { type: "选择题", content: "贝贝最后（ ）。\nA. 还是丢文具  B. 学会了爱护文具  C. 不用文具了", answer: "B", difficulty: 1 },
      { type: "判断题", content: "文具是我们的好朋友，要好好爱护它们。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "橡皮的\"家\"是（ ）。", answer: "铅笔盒", difficulty: 1 },
      { type: "选择题", content: "这篇课文告诉我们要养成（ ）的好习惯。\nA. 读书  B. 整理物品  C. 运动", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我以后要把用完的文具（ ）。", answer: "放回铅笔盒里", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写的是（ ）看着（ ）睡觉的样子。", answer: "\"我\"；妈妈", difficulty: 1 },
      { type: "填空题", content: "妈妈睡觉时，嘴巴（ ），好像在给我讲故事。", answer: "微微张开", difficulty: 1 },
      { type: "选择题", content: "妈妈睡觉时，呼吸（ ）。\nA. 很急促  B. 很均匀  C. 停止了", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"我\"觉得妈妈很累。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，妈妈的头发（ ）在脸上。", answer: "垂下来", difficulty: 1 },
      { type: "选择题", content: "\"我\"看到妈妈睡觉的样子，心里（ ）。\nA. 很高兴  B. 很心疼  C. 很生气", answer: "B", difficulty: 2 },
      { type: "判断题", content: "这篇课文表达了\"我\"对妈妈的爱。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中用了（ ）的手法来描写妈妈。", answer: "外貌描写和细节描写", difficulty: 2 },
      { type: "选择题", content: "妈妈睡觉时，\"我\"在（ ）。\nA. 玩耍  B. 看着妈妈  C. 写作业", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我感受到了（ ）。", answer: "母爱的伟大和孩子对妈妈的爱", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "\"我\"会变成（ ）、（ ）、（ ）、（ ）。", answer: "云；雨；冰雹；雪", difficulty: 1 },
      { type: "选择题", content: "\"我\"在池子里（ ），在小溪里（ ），在江河里（ ），在海洋里（ ）。\nA. 跑步  B. 散步  C. 唱歌  D. 跳舞", answer: "睡觉；散步；奔跑；跳舞", difficulty: 2 },
      { type: "判断题", content: "\"我\"是水。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "太阳一晒，\"我\"就变成（ ）。", answer: "汽", difficulty: 1 },
      { type: "选择题", content: "\"我\"变成雨落下来，人们叫我（ ）。\nA. 雪  B. 雨  C. 冰雹", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"我\"做过的好事有灌溉田地、发动机器。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "\"我\"也做过坏事，比如（ ）、（ ）。", answer: "淹没庄稼；冲毁房屋", difficulty: 2 },
      { type: "选择题", content: "课文用（ ）的人称来写水。\nA. 第一人称  B. 第二人称  C. 第三人称", answer: "A", difficulty: 1 },
      { type: "判断题", content: "水只有一种状态。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "这篇课文是一篇（ ）文。", answer: "科学童话（或科普）", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "\"我\"有一大把（ ）的梦。", answer: "彩色", difficulty: 1 },
      { type: "填空题", content: "课文中，草坪是（ ）色的，花朵是（ ）色的，天空是（ ）色的。", answer: "绿；红；蓝", difficulty: 1 },
      { type: "选择题", content: "\"我\"用彩色铅笔画的森林里有（ ）。\nA. 小鸟  B. 雪松  C. 小熊", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文中的\"梦\"指的是用彩色铅笔画出来的画。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，\"我\"画了（ ）、（ ）、（ ）等景物。", answer: "草坪；野花；天空", difficulty: 1 },
      { type: "选择题", content: "\"彩色\"在课文中代表（ ）。\nA. 铅笔的颜色  B. 美好的想象  C. 黑白", answer: "B", difficulty: 2 },
      { type: "判断题", content: "这首诗歌表达了小朋友丰富的想象力。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，\"我\"的彩色梦境里有（ ）、（ ）。", answer: "水果香；季节风", difficulty: 2 },
      { type: "选择题", content: "这首诗歌的体裁是（ ）。\nA. 记叙文  B. 诗歌  C. 说明文", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这首诗，我觉得小作者的想象力很（ ）。", answer: "丰富", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写的是孩子们在（ ）上玩耍的故事。", answer: "沙滩", difficulty: 1 },
      { type: "填空题", content: "孩子们在沙滩上垒起了一座（ ）。", answer: "城堡", difficulty: 1 },
      { type: "选择题", content: "孩子们编了一个关于（ ）的故事。\nA. 城堡  B. 勇士救公主  C. 沙滩", answer: "B", difficulty: 1 },
      { type: "判断题", content: "孩子们在沙滩上玩得很开心。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "故事中，勇士要打败（ ），救出（ ）。", answer: "魔王；公主", difficulty: 1 },
      { type: "选择题", content: "孩子们用什么当\"武器\"？（ ）\nA. 真刀真枪  B. 树枝  C. 沙子", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文体现了孩子们的想象力和创造力。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，\"我们\"在沙滩上（ ）城堡、（ ）故事。", answer: "垒；编", difficulty: 1 },
      { type: "选择题", content: "这篇课文告诉我们（ ）。\nA. 沙滩很好玩  B. 孩子们的想象力很丰富  C. 要打败坏人", answer: "B", difficulty: 2 },
      { type: "填空题", content: "沙滩是孩子们的（ ）。", answer: "乐园", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "秋天的雨是一把（ ）。", answer: "钥匙", difficulty: 1 },
      { type: "填空题", content: "秋天的雨有（ ）颜色的颜料。", answer: "五彩缤纷的", difficulty: 1 },
      { type: "选择题", content: "课文中，秋天的雨把黄色给了（ ）。\nA. 枫树  B. 银杏树  C. 柿子树", answer: "B", difficulty: 1 },
      { type: "选择题", content: "秋天的雨把红色给了（ ）。\nA. 银杏树  B. 柿子树  C. 枫树", answer: "C", difficulty: 1 },
      { type: "判断题", content: "\"五彩缤纷\"的意思是颜色很多，非常好看。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "秋天的雨藏着非常好闻的（ ）。", answer: "气味", difficulty: 1 },
      { type: "选择题", content: "课文中用了（ ）的手法来写秋天的雨。\nA. 拟人  B. 夸张  C. 排比", answer: "A", difficulty: 2 },
      { type: "判断题", content: "秋天的雨带来了丰收的喜悦。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，橘子、柿子是（ ）色的。", answer: "橙红", difficulty: 1 },
      { type: "选择题", content: "这篇课文表达了作者对秋天的（ ）之情。\nA. 讨厌  B. 喜爱和赞美  C. 害怕", answer: "B", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写的是兄弟俩在（ ）上玩耍的事。", answer: "草地", difficulty: 1 },
      { type: "填空题", content: "草地是（ ）色的，因为草地上的花是（ ）色的。", answer: "金色；金色", difficulty: 1 },
      { type: "选择题", content: "草地变成金色是因为（ ）。\nA. 草变黄了  B. 蒲公英的花合拢了  C. 太阳照射", answer: "B", difficulty: 2 },
      { type: "判断题", content: "蒲公英的花像手掌一样，可以张开和合上。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "早上，蒲公英的花是（ ）的，草地是（ ）色的。", answer: "张开；绿色", difficulty: 2 },
      { type: "选择题", content: "中午，蒲公英的花（ ），草地变成（ ）色的。\nA. 张开；金色  B. 合拢；绿色  C. 张开；绿色", answer: "A", difficulty: 2 },
      { type: "判断题", content: "作者通过仔细观察发现了蒲公英的秘密。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "蒲公英早上（ ），中午（ ），傍晚（ ）。", answer: "合拢；张开；合拢", difficulty: 2 },
      { type: "选择题", content: "这篇课文告诉我们要（ ）。\nA. 多玩游戏  B. 仔细观察周围的事物  C. 不用学习", answer: "B", difficulty: 1 },
      { type: "填空题", content: "课文表达了作者对大自然的（ ）之情。", answer: "热爱", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "《童年的水墨画》是一组（ ）。", answer: "儿童诗", difficulty: 1 },
      { type: "选择题", content: "这组诗包括《溪边》、《（ ）》和《林中》。", answer: "A", difficulty: 1 },
      { type: "填空题", content: "《溪边》中，\"人影给溪水染绿了\"说明（ ）。", answer: "溪水很绿，倒映着人影", difficulty: 2 },
      { type: "判断题", content: "《江上》写的是孩子们在江里游泳的情景。（ ）", answer: "√", difficulty: 1 },
      { type: "选择题", content: "《溪边》中，\"钓竿上立着一只红蜻蜓\"说明（ ）。\nA. 蜻蜓很多  B. 环境很安静  C. 天气很热", answer: "B", difficulty: 2 },
      { type: "填空题", content: "《林中》写的是孩子们在（ ）里采蘑菇的情景。", answer: "松林", difficulty: 1 },
      { type: "判断题", content: "这组诗歌充满了童趣。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "《江上》中，孩子们像（ ）一样在水中嬉戏。", answer: "鸭子", difficulty: 1 },
      { type: "选择题", content: "这组诗歌主要描写了（ ）。\nA. 大自然的美景  B. 童年生活的快乐  C. 城市生活", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这组诗，我感受到了童年的（ ）。", answer: "快乐和美好", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文中的\"剃头大师\"指的是（ ）。", answer: "\"我\"（小沙的表哥）", difficulty: 1 },
      { type: "填空题", content: "小沙最怕（ ）。", answer: "剃头", difficulty: 1 },
      { type: "选择题", content: "小沙让\"我\"给他剃头是因为（ ）。\nA. \"我\"技术好  B. 不用付钱  C. 老师傅剃头太疼", answer: "C", difficulty: 1 },
      { type: "判断题", content: "\"我\"给小沙剃头的水平很高。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "\"我\"把小沙的头发剪得（ ）。", answer: "坑坑洼洼", difficulty: 1 },
      { type: "选择题", content: "最后小沙的头发（ ）。\nA. 很漂亮  B. 只好去理发店剃光  C. 没有剪", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文用了幽默的语言来写故事。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中的\"害人精\"指的是（ ）。", answer: "剃头老师傅", difficulty: 1 },
      { type: "选择题", content: "这篇课文主要写了（ ）。\nA. 剃头的技术  B. 童年趣事  C. 理发店的故事", answer: "B", difficulty: 1 },
      { type: "填空题", content: "\"剃头大师\"这个题目用了（ ）的手法。", answer: "反语（或幽默）", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "一个豆荚里有（ ）粒豌豆。", answer: "五", difficulty: 1 },
      { type: "选择题", content: "第五粒豌豆落在了（ ）。\nA. 田地里  B. 窗台上的裂缝里  C. 水里", answer: "B", difficulty: 1 },
      { type: "判断题", content: "第五粒豌豆让一个生病的小女孩恢复了健康。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "小女孩因为生病，很（ ），不能出去。", answer: "瘦弱", difficulty: 1 },
      { type: "选择题", content: "第五粒豌豆发芽后，小女孩（ ）。\nA. 没有变化  B. 变得更虚弱  C. 渐渐恢复了健康", answer: "C", difficulty: 1 },
      { type: "判断题", content: "其他四粒豌豆都实现了自己的愿望。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "豌豆苗给小女孩带来了（ ）。", answer: "希望和快乐", difficulty: 2 },
      { type: "选择题", content: "这篇童话的作者是（ ）。\nA. 安徒生  B. 格林兄弟  C. 冰心", answer: "A", difficulty: 1 },
      { type: "判断题", content: "课文告诉我们，生命的力量是伟大的。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我觉得（ ）的生命力最顽强。", answer: "第五粒豌豆", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "科学家通过研究（ ），发明了（ ）。", answer: "蝙蝠；雷达", difficulty: 1 },
      { type: "填空题", content: "蝙蝠在夜里飞行，靠的不是眼睛，而是（ ）。", answer: "嘴和耳朵", difficulty: 1 },
      { type: "选择题", content: "蝙蝠发出的声音叫（ ）。\nA. 叫声  B. 超声波  C. 音乐", answer: "B", difficulty: 1 },
      { type: "判断题", content: "蝙蝠在夜里飞行不会撞到东西。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "雷达通过（ ）和（ ）来探测目标。", answer: "天线；荧光屏", difficulty: 2 },
      { type: "选择题", content: "科学家做了（ ）次实验来研究蝙蝠。", answer: "B", difficulty: 2 },
      { type: "判断题", content: "蝙蝠的眼睛在夜里也能看到东西。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "雷达的工作原理是模仿蝙蝠的（ ）原理。", answer: "回声定位", difficulty: 2 },
      { type: "选择题", content: "这篇课文是一篇（ ）文。\nA. 记叙文  B. 说明文  C. 议论文", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我知道了人们可以从（ ）身上得到启发，发明新东西。", answer: "动物", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "小英雄雨来是（ ）人。", answer: "晋察冀边区（或芦花村）", difficulty: 1 },
      { type: "选择题", content: "雨来最擅长（ ）。\nA. 跑步  B. 游泳  C. 射击", answer: "B", difficulty: 1 },
      { type: "判断题", content: "雨来为了保护交通员李大叔，被鬼子抓住了。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "鬼子想让雨来（ ），但雨来没有说。", answer: "交出李大叔", difficulty: 1 },
      { type: "选择题", content: "雨来最后（ ）。\nA. 被鬼子杀害了  B. 趁鬼子不注意逃走了  C. 被救了", answer: "B", difficulty: 2 },
      { type: "判断题", content: "雨来是一个机智勇敢的孩子。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，\"我们是中国人，我们爱自己的祖国\"这句话出现了（ ）次。", answer: "三", difficulty: 2 },
      { type: "选择题", content: "这篇课文的体裁是（ ）。\nA. 诗歌  B. 小说（节选）  C. 散文", answer: "B", difficulty: 1 },
      { type: "判断题", content: "雨来游泳技术很好，这帮助他逃走了。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "雨来的故事发生在（ ）时期。", answer: "抗日战争", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文的主人公是（ ）。", answer: "青铜", difficulty: 1 },
      { type: "填空题", content: "青铜是（ ）的孩子。", answer: "葵花家（或乡下）", difficulty: 1 },
      { type: "选择题", content: "青铜编了（ ）双芦花鞋去卖。", answer: "B", difficulty: 2 },
      { type: "判断题", content: "青铜最后把脚上穿的芦花鞋也卖掉了。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "芦花鞋是用（ ）编的。", answer: "芦花", difficulty: 1 },
      { type: "选择题", content: "青铜卖芦花鞋是为了（ ）。\nA. 自己玩  B. 换钱给家里  C. 送人", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文描写了青铜在雪地里卖鞋的情景，很感人。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文选自曹文轩的小说（ ）。", answer: "《青铜葵花》", difficulty: 1 },
      { type: "选择题", content: "这篇课文表现了青铜（ ）的品质。\nA. 聪明  B. 勤劳善良  C. 胆小", answer: "B", difficulty: 2 },
      { type: "填空题", content: "学了这篇课文，我被青铜的（ ）感动了。", answer: "勤劳和坚强", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写的是\"我\"和（ ）之间的故事。", answer: "珍珠鸟", difficulty: 1 },
      { type: "填空题", content: "珍珠鸟一开始很（ ），后来渐渐和\"我\"亲近了。", answer: "怕人", difficulty: 1 },
      { type: "选择题", content: "珍珠鸟最后在\"我\"的（ ）上睡着了。\nA. 手  B. 肩  C. 头", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文告诉我们，信赖往往创造出美好的境界。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "\"我\"给珍珠鸟做了一个（ ）。", answer: "笼子", difficulty: 1 },
      { type: "选择题", content: "珍珠鸟的雏儿长得（ ）。\nA. 很丑  B. 很漂亮  C. 很大", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"我\"从不打扰珍珠鸟的生活。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文的作者是（ ）。", answer: "冯骥才", difficulty: 1 },
      { type: "选择题", content: "这篇课文表达了（ ）的主题。\nA. 保护动物  B. 人与动物之间的信任  C. 养鸟的方法", answer: "B", difficulty: 2 },
      { type: "填空题", content: "\"信赖，往往创造出美好的境界\"中\"信赖\"指的是（ ）。", answer: "珍珠鸟对\"我\"的信任", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写的是种（ ）、收花生和（ ）的过程。", answer: "花生；议花生", difficulty: 1 },
      { type: "选择题", content: "父亲说花生最可贵的地方是（ ）。\nA. 好吃  B. 不好看但有用  C. 好看", answer: "B", difficulty: 1 },
      { type: "判断题", content: "父亲希望孩子们做像花生一样的人。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "花生虽然不好看，但是很（ ）。", answer: "有用", difficulty: 1 },
      { type: "选择题", content: "课文运用了（ ）的写法。\nA. 借物喻人  B. 托物言志  C. 两者都是", answer: "C", difficulty: 2 },
      { type: "判断题", content: "桃子、石榴、苹果不好，花生最好。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "课文中，父亲把花生和（ ）、（ ）、（ ）作比较。", answer: "桃子；石榴；苹果", difficulty: 1 },
      { type: "选择题", content: "课文的作者是（ ）。\nA. 老舍  B. 许地山  C. 巴金", answer: "B", difficulty: 1 },
      { type: "判断题", content: "落花生是许地山的笔名。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "学了这篇课文，我明白了做人要做（ ）的人。", answer: "朴实无华但对社会有用", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文选自（ ）写的《西游记》。", answer: "吴承恩", difficulty: 1 },
      { type: "填空题", content: "石猴是从（ ）里蹦出来的。", answer: "仙石", difficulty: 1 },
      { type: "选择题", content: "石猴第一个跳进了（ ）。\nA. 水帘洞  B. 花果山  C. 天宫", answer: "A", difficulty: 1 },
      { type: "判断题", content: "石猴被大家称为\"美猴王\"。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "石猴发现水帘洞里（ ）、（ ）。", answer: "石座；石碗", difficulty: 1 },
      { type: "选择题", content: "石猴带领猴子们住进了（ ）。\nA. 山洞  B. 水帘洞  C. 树上", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文用了生动的语言描写了石猴的勇敢和聪明。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "石猴的性格特点是（ ）。", answer: "勇敢、聪明、有领导力", difficulty: 2 },
      { type: "选择题", content: "这篇课文是一篇（ ）。\nA. 原创小说  B. 古白话小说节选  C. 现代文", answer: "B", difficulty: 1 },
      { type: "填空题", content: "水帘洞在（ ）上。", answer: "花果山", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文选自（ ）写的《红楼梦》。", answer: "曹雪芹", difficulty: 1 },
      { type: "填空题", content: "课文写的是（ ）等人在大观园里放风筝的事。", answer: "宝玉、黛玉", difficulty: 1 },
      { type: "选择题", content: "课文中的主要活动是（ ）。\nA. 赏花  B. 放风筝  C. 写诗", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文描写了春天的景色和人物的活动。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "宝玉放的风筝是（ ）。", answer: "大蝴蝶", difficulty: 1 },
      { type: "选择题", content: "《红楼梦》中，大观园是（ ）的地方。\nA. 贾宝玉和姐妹们  B. 皇帝  C. 老百姓", answer: "A", difficulty: 1 },
      { type: "判断题", content: "课文中的人物对话很有个性特点。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "课文表达了（ ）的乐趣。", answer: "春天放风筝", difficulty: 1 },
      { type: "选择题", content: "《红楼梦》是中国古典四大名著之一，其他三部是（ ）。\nA. 三国演义、水浒传、西游记  B. 论语、孟子、大学  C. 诗经、楚辞、离骚", answer: "A", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我感受到了古代（ ）的生活情趣。", answer: "贵族少年", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "《好的故事》的作者是（ ）。", answer: "鲁迅", difficulty: 1 },
      { type: "选择题", content: "这篇课文选自鲁迅的散文诗集（ ）。\nA. 《朝花夕拾》  B. 《野草》  C. 《呐喊》", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"好的故事\"是作者在梦中看到的美丽景象。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中的\"好的故事\"其实是一个（ ）。", answer: "梦", difficulty: 1 },
      { type: "选择题", content: "课文中描写了水中的（ ）等景物。\nA. 山  B. 各种花草和倒影  C. 房屋", answer: "B", difficulty: 2 },
      { type: "判断题", content: "\"好的故事\"象征了作者对美好生活的向往。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "课文写于（ ）年。", answer: "1925", difficulty: 2 },
      { type: "选择题", content: "这篇课文的写作特点是（ ）。\nA. 语言简洁  B. 意象丰富，象征性强  C. 叙事性强", answer: "B", difficulty: 2 },
      { type: "判断题", content: "鲁迅是现代伟大的文学家、思想家。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，\"昏沉的夜\"象征着（ ）。", answer: "黑暗的社会现实", difficulty: 3 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写了关于鲁迅先生的（ ）件事。", answer: "四", difficulty: 1 },
      { type: "选择题", content: "课文的作者是鲁迅的（ ）。\nA. 儿子  B. 侄女  C. 学生", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"伯父\"指的是鲁迅先生。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，鲁迅先生谈《水浒传》教育\"我\"要（ ）。", answer: "认真读书", difficulty: 1 },
      { type: "选择题", content: "鲁迅先生说的\"碰壁\"意思是（ ）。\nA. 真的撞墙了  B. 遇到困难和挫折  C. 走路不小心", answer: "B", difficulty: 2 },
      { type: "判断题", content: "鲁迅先生是一个为自己想得少、为别人想得多的人。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，鲁迅先生救助了一个（ ）。", answer: "拉车的车夫", difficulty: 1 },
      { type: "选择题", content: "鲁迅先生的名言\"横眉冷对千夫指，俯首甘为孺子牛\"表现了他（ ）的精神。", answer: "A", difficulty: 2 },
      { type: "判断题", content: "课文表达了作者对伯父鲁迅的怀念和敬爱。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我觉得鲁迅先生是一个（ ）的人。", answer: "关心他人、爱憎分明", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "《骑鹅旅行记》的作者是（ ）国作家塞尔玛·拉格洛夫。", answer: "瑞典", difficulty: 1 },
      { type: "选择题", content: "主人公尼尔斯变成了（ ）。\nA. 狐狸  B. 小精灵  C. 小人儿", answer: "C", difficulty: 1 },
      { type: "判断题", content: "尼尔斯骑着家鹅马丁飞上了天空。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "尼尔斯一开始是一个（ ）的男孩。", answer: "调皮捣蛋、不爱学习", difficulty: 1 },
      { type: "选择题", content: "在旅行中，尼尔斯变得（ ）。\nA. 更调皮  B. 善良勇敢  C. 更懒惰", answer: "B", difficulty: 1 },
      { type: "判断题", content: "《骑鹅旅行记》是世界文学名著。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "尼尔斯跟着大雁群飞越了（ ）。（填国家名）", answer: "瑞典", difficulty: 1 },
      { type: "选择题", content: "这部作品是（ ）文学中的一部经典。\nA. 中国  B. 瑞典  C. 美国", answer: "B", difficulty: 1 },
      { type: "判断题", content: "尼尔斯在旅途中帮助了很多动物。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我明白了（ ）的道理。", answer: "要善良、勇敢、乐于助人", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "《汤姆·索亚历险记》的作者是（ ）。", answer: "马克·吐温", difficulty: 1 },
      { type: "选择题", content: "汤姆·索亚是（ ）国的孩子。", answer: "B", difficulty: 1 },
      { type: "判断题", content: "汤姆和哈克在墓地目击了一场凶杀案。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "汤姆和（ ）在山洞里迷了路。", answer: "贝琪", difficulty: 1 },
      { type: "选择题", content: "汤姆是一个（ ）的孩子。\nA. 胆小怕事  B. 聪明勇敢、爱冒险  C. 懒惰", answer: "B", difficulty: 1 },
      { type: "判断题", content: "汤姆最后找到了山洞的出口，安全出来了。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "汤姆和哈克找到了（ ）的宝藏。", answer: "印第安·乔", difficulty: 2 },
      { type: "选择题", content: "这部小说主要描写了（ ）。\nA. 大人的世界  B. 孩子们的冒险生活  C. 学校生活", answer: "B", difficulty: 1 },
      { type: "判断题", content: "马克·吐温是美国著名的作家。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我觉得汤姆是一个（ ）的人。", answer: "勇敢、机智、有正义感", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"bread\"的意思是（ ）。\nA. 牛奶  B. 面包  C. 鸡蛋", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"juice\"的意思是（ ）。\nA. 果汁  B. 水  C. 茶", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"milk\"的意思是（ ）。\nA. 面包  B. 鸡蛋  C. 牛奶", answer: "C", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\negg —（ ）  rice —（ ）  water —（ ）", answer: "鸡蛋；米饭；水", difficulty: 1 },
      { type: "情景交际", content: "你想表达\"我饿了\"，你应该说（ ）。\nA. I am hungry.  B. I am thirsty.  C. I am tired.", answer: "A", difficulty: 1 },
      { type: "情景交际", content: "你想表达\"请给我一些面包\"，你应该说（ ）。\nA. I like bread.  B. Can I have some bread, please?  C. Here you are.", answer: "B", difficulty: 2 },
      { type: "选择题", content: "别人对你说\"Here you are.\"，你应该回答（ ）。\nA. Thank you.  B. Hello.  C. Goodbye.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"cake\"的意思是（ ）。\nA. 面包  B. 蛋糕  C. 鱼", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你想要什么？\"，你应该说（ ）。\nA. What do you like?  B. What would you like?  C. How are you?", answer: "B", difficulty: 2 },
      { type: "连词成句", content: "连词成句：like / I / bread", answer: "I like bread.", difficulty: 1 }
    ],
  },

  {
    id: "en-g3s-u7",
    unitName: "Happy New Year!",
    grade: 3,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"gift\"的意思是（ ）。\nA. 礼物  B. 卡片  C. 花", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"card\"的意思是（ ）。\nA. 书  B. 卡片  C. 纸", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "新年时你应该说（ ）。\nA. Happy New Year!  B. Happy Birthday!  C. Merry Christmas!", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Happy New Year!\"的回答是（ ）。\nA. Thank you.  B. Happy New Year!  C. You are welcome.", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nfirework —（ ）  lantern —（ ）", answer: "烟花；灯笼", difficulty: 1 },
      { type: "单词选择", content: "\"new\"的意思是（ ）。\nA. 旧的  B. 新的  C. 大的", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想表达\"这是给你的礼物\"，你应该说（ ）。\nA. This is for you.  B. This is me.  C. Give me.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "\"The same to you!\"的意思是（ ）。\nA. 谢谢你  B. 你也一样  C. 再见", answer: "B", difficulty: 2 },
      { type: "单词选择", content: "\"year\"的意思是（ ）。\nA. 月  B. 日  C. 年", answer: "C", difficulty: 1 },
      { type: "判断题", content: "\"Happy New Year!\"只在1月1日使用。（ ）", answer: "×", difficulty: 2 }
    ],
  },

  {
    id: "en-g3x-u6",
    unitName: "Do you like pears?",
    grade: 3,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"pear\"的意思是（ ）。\nA. 苹果  B. 梨  C. 香蕉", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"peach\"的意思是（ ）。\nA. 桃子  B. 西瓜  C. 葡萄", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"grape\"的意思是（ ）。\nA. 苹果  B. 香蕉  C. 葡萄", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你喜欢梨吗？\"，你应该说（ ）。\nA. Do you like pears?  B. I like pears.  C. Have some pears.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Do you like apples?\"的肯定回答是（ ）。\nA. No, I do not.  B. Yes, I do.  C. Yes, I am.", answer: "B", difficulty: 1 },
      { type: "选择题", content: "\"Do you like oranges?\"的否定回答是（ ）。\nA. Yes, I do.  B. No, I do not.  C. No, I am.", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nwatermelon —（ ）  strawberry —（ ）", answer: "西瓜；草莓", difficulty: 1 },
      { type: "情景交际", content: "你想表达\"我喜欢香蕉\"，你应该说（ ）。\nA. I like bananas.  B. I do not like bananas.  C. Do you like bananas?", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"orange\"的意思是（ ）。\nA. 橙子  B. 苹果  C. 梨", answer: "A", difficulty: 1 },
      { type: "连词成句", content: "连词成句：you / Do / like / grapes ?", answer: "Do you like grapes?", difficulty: 1 }
    ],
  },

  {
    id: "en-g3x-u7",
    unitName: "Where is my car?",
    grade: 3,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"on\"的意思是（ ）。\nA. 在…上面  B. 在…下面  C. 在…里面", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"under\"的意思是（ ）。\nA. 在…上面  B. 在…下面  C. 在…里面", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"in\"的意思是（ ）。\nA. 在…上面  B. 在…下面  C. 在…里面", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想问\"我的书在哪里？\"，你应该说（ ）。\nA. Where is my book?  B. What is this?  C. Is this a book?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Where is my car?\"的回答可能是（ ）。\nA. It is on the desk.  B. It is a car.  C. I like cars.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"desk\"的意思是（ ）。\nA. 椅子  B. 桌子  C. 书包", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"chair\"的意思是（ ）。\nA. 椅子  B. 桌子  C. 床", answer: "A", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nbox —（ ）  ball —（ ）", answer: "盒子；球", difficulty: 1 },
      { type: "情景交际", content: "你想说\"它在椅子下面\"，你应该说（ ）。\nA. It is on the chair.  B. It is under the chair.  C. It is in the chair.", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"Where is my ruler?\"是问尺子在哪里。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g4s-u6",
    unitName: "Is she your mother?",
    grade: 4,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"mother\"的意思是（ ）。\nA. 爸爸  B. 妈妈  C. 姐姐", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"father\"的意思是（ ）。\nA. 爸爸  B. 叔叔  C. 哥哥", answer: "A", difficulty: 1 },
      { type: "情景交际", content: "你想问\"她是你的妈妈吗？\"，你应该说（ ）。\nA. Is she your mother?  B. Is he your father?  C. Are you my mother?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Is she your sister?\"的肯定回答是（ ）。\nA. Yes, she is.  B. No, she is not.  C. Yes, he is.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"brother\"的意思是（ ）。\nA. 姐姐  B. 妹妹  C. 哥哥/弟弟", answer: "C", difficulty: 1 },
      { type: "单词选择", content: "\"sister\"的意思是（ ）。\nA. 哥哥  B. 姐姐/妹妹  C. 叔叔", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nuncle —（ ）  aunt —（ ）", answer: "叔叔/舅舅；阿姨/姑姑", difficulty: 1 },
      { type: "情景交际", content: "你想介绍\"这是我的爸爸\"，你应该说（ ）。\nA. This is my father.  B. That is my mother.  C. He is my brother.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"grandmother\"的意思是（ ）。\nA. 奶奶/外婆  B. 姑姑  C. 阿姨", answer: "A", difficulty: 1 },
      { type: "判断题", content: "\"He is my mother.\"这句话是正确的。（ ）", answer: "×", difficulty: 1 }
    ],
  },

  {
    id: "en-g4s-u7",
    unitName: "What's his job?",
    grade: 4,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"doctor\"的意思是（ ）。\nA. 老师  B. 医生  C. 司机", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"teacher\"的意思是（ ）。\nA. 医生  B. 护士  C. 老师", answer: "C", difficulty: 1 },
      { type: "单词选择", content: "\"driver\"的意思是（ ）。\nA. 农民  B. 司机  C. 厨师", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"他是做什么工作的？\"，你应该说（ ）。\nA. What is his job?  B. Who is he?  C. How old is he?", answer: "A", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nfarmer —（ ）  cook —（ ）", answer: "农民；厨师", difficulty: 1 },
      { type: "单词选择", content: "\"nurse\"的意思是（ ）。\nA. 医生  B. 护士  C. 老师", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想说\"她是一名护士\"，你应该说（ ）。\nA. She is a nurse.  B. He is a doctor.  C. I am a teacher.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"What is her job?\"的回答可能是（ ）。\nA. She is a teacher.  B. He is a doctor.  C. I am fine.", answer: "A", difficulty: 2 },
      { type: "单词选择", content: "\"football player\"的意思是（ ）。\nA. 篮球运动员  B. 足球运动员  C. 排球运动员", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"He is a cook.\"意思是\"他是一名厨师\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g4x-u6",
    unitName: "Can I help you?",
    grade: 4,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "情景交际", content: "售货员问\"Can I help you?\"意思是（ ）。\nA. 你能帮我吗？  B. 我能帮助你吗？（您要买什么？）  C. 谢谢", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想说\"请给我那个\"，你应该说（ ）。\nA. Give me that.  B. Can I have that, please?  C. I want that.", answer: "B", difficulty: 2 },
      { type: "单词选择", content: "\"shoes\"的意思是（ ）。\nA. 裤子  B. 鞋子  C. 衬衫", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"pants\"的意思是（ ）。\nA. 裙子  B. 裤子  C. 外套", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\ndress —（ ）  coat —（ ）", answer: "连衣裙；外套", difficulty: 1 },
      { type: "情景交际", content: "你想问\"多少钱？\"，你应该说（ ）。\nA. How are you?  B. How much is it?  C. How old are you?", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"expensive\"的意思是（ ）。\nA. 便宜的  B. 昂贵的  C. 好看的", answer: "B", difficulty: 2 },
      { type: "单词选择", content: "\"cheap\"的意思是（ ）。\nA. 便宜的  B. 昂贵的  C. 大的", answer: "A", difficulty: 1 },
      { type: "情景交际", content: "你想说\"太贵了\"，你应该说（ ）。\nA. It is too cheap.  B. It is too expensive.  C. It is OK.", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"Can I help you?\"只在商店使用。（ ）", answer: "×", difficulty: 2 }
    ],
  },

  {
    id: "en-g4x-u7",
    unitName: "Is this your skirt?",
    grade: 4,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"skirt\"的意思是（ ）。\nA. 裤子  B. 裙子  C. 外套", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"shirt\"的意思是（ ）。\nA. T恤  B. 衬衫  C. 裙子", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"这是你的裙子吗？\"，你应该说（ ）。\nA. Is this your skirt?  B. Is that my shirt?  C. Are these your pants?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Is this your jacket?\"的肯定回答是（ ）。\nA. Yes, it is.  B. No, it is not.  C. Yes, I am.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"jacket\"的意思是（ ）。\nA. 夹克  B. 裤子  C. 鞋子", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"sweater\"的意思是（ ）。\nA. 短袖  B. 毛衣  C. 外套", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nT-shirt —（ ）  shorts —（ ）", answer: "T恤衫；短裤", difficulty: 1 },
      { type: "情景交际", content: "你想说\"那不是我的\"，你应该说（ ）。\nA. That is mine.  B. That is not mine.  C. This is yours.", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"uniform\"的意思是（ ）。\nA. 便装  B. 校服  C. 运动服", answer: "B", difficulty: 2 },
      { type: "判断题", content: "\"These are my shoes.\"意思是\"这些是我的鞋子\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g5s-u6",
    unitName: "What can you do?",
    grade: 5,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"sing\"的意思是（ ）。\nA. 跳  B. 唱  C. 跑", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"dance\"的意思是（ ）。\nA. 唱歌  B. 画画  C. 跳舞", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你会做什么？\"，你应该说（ ）。\nA. What can you do?  B. What do you like?  C. Who are you?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"I can swim.\"的意思是（ ）。\nA. 我会游泳。  B. 我会跑步。  C. 我会跳舞。", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"draw\"的意思是（ ）。\nA. 画  B. 写  C. 读", answer: "A", difficulty: 1 },
      { type: "情景交际", content: "你想表达\"我会弹钢琴\"，你应该说（ ）。\nA. I can play the piano.  B. I can play football.  C. I can sing.", answer: "A", difficulty: 2 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\ncook —（ ）  clean —（ ）", answer: "做饭；打扫", difficulty: 1 },
      { type: "选择题", content: "\"Can you play basketball?\"的肯定回答是（ ）。\nA. Yes, I can.  B. No, I can not.  C. Yes, I do.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"kung fu\"的意思是（ ）。\nA. 篮球  B. 武术  C. 足球", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"She can sing English songs.\"意思是\"她会唱英文歌\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g5s-u7",
    unitName: "There is a big bed (拓展)",
    grade: 5,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"bedroom\"的意思是（ ）。\nA. 客厅  B. 卧室  C. 厨房", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"living room\"的意思是（ ）。\nA. 卧室  B. 浴室  C. 客厅", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想说\"房间里有一张大床\"，你应该说（ ）。\nA. There is a big bed in the room.  B. There are two beds.  C. I have a bed.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"There is a desk and two chairs.\"意思是（ ）。\nA. 有一张桌子和两把椅子  B. 有两张桌子和一把椅子  C. 有三把椅子", answer: "A", difficulty: 2 },
      { type: "单词选择", content: "\"bathroom\"的意思是（ ）。\nA. 浴室  B. 卧室  C. 阳台", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"kitchen\"的意思是（ ）。\nA. 客厅  B. 厨房  C. 餐厅", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nstudy —（ ）  balcony —（ ）", answer: "书房；阳台", difficulty: 1 },
      { type: "情景交际", content: "你想描述\"照片里有一面镜子\"，你应该说（ ）。\nA. There is a mirror in the picture.  B. I have a picture.  C. The mirror is big.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "\"There are many books on the shelf.\"中，\"shelf\"的意思是（ ）。\nA. 桌子  B. 椅子  C. 书架", answer: "C", difficulty: 1 },
      { type: "判断题", content: "\"There is\"后面跟单数名词，\"There are\"后面跟复数名词。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g5x-u6",
    unitName: "How do you come to school?",
    grade: 5,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"bus\"的意思是（ ）。\nA. 汽车  B. 公共汽车  C. 自行车", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"bike\"的意思是（ ）。\nA. 公共汽车  B. 火车  C. 自行车", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你怎么去学校？\"，你应该说（ ）。\nA. How do you come to school?  B. Where is the school?  C. What is this?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"I usually come by bus.\"的意思是（ ）。\nA. 我通常坐公共汽车来。  B. 我通常走路来。  C. 我通常骑车来。", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"subway\"的意思是（ ）。\nA. 地铁  B. 出租车  C. 飞机", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"taxi\"的意思是（ ）。\nA. 公共汽车  B. 出租车  C. 地铁", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\non foot —（ ）  by train —（ ）", answer: "步行；坐火车", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我步行上学\"，你应该说（ ）。\nA. I come to school on foot.  B. I come to school by bus.  C. I come to school by plane.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"plane\"的意思是（ ）。\nA. 火车  B. 轮船  C. 飞机", answer: "C", difficulty: 1 },
      { type: "判断题", content: "\"by bike\"和\"ride a bike\"意思相同。（ ）", answer: "√", difficulty: 2 }
    ],
  },

  {
    id: "en-g5x-u7",
    unitName: "What does he do?",
    grade: 5,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"factory worker\"的意思是（ ）。\nA. 农民  B. 工厂工人  C. 医生", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"postman\"的意思是（ ）。\nA. 警察  B. 邮递员  C. 司机", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"他是做什么工作的？\"，你应该说（ ）。\nA. What does he do?  B. What is he doing?  C. Where is he?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"She is a nurse.\"的意思是（ ）。\nA. 她是一名老师。  B. 她是一名护士。  C. 她是一名医生。", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"businessman\"的意思是（ ）。\nA. 商人  B. 警察  C. 科学家", answer: "A", difficulty: 2 },
      { type: "单词选择", content: "\"scientist\"的意思是（ ）。\nA. 老师  B. 医生  C. 科学家", answer: "C", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\npolice officer —（ ）  pilot —（ ）", answer: "警察；飞行员", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我的妈妈是一名老师\"，你应该说（ ）。\nA. My mother is a teacher.  B. My father is a doctor.  C. I am a student.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"Where does he work?\"的回答可能是（ ）。\nA. He works in a hospital.  B. He is tall.  C. He likes apples.", answer: "A", difficulty: 2 },
      { type: "判断题", content: "\"What does she do?\"和\"What is her job?\"意思相同。（ ）", answer: "√", difficulty: 2 }
    ],
  },

  {
    id: "en-g6s-u6",
    unitName: "How do you feel?",
    grade: 6,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"angry\"的意思是（ ）。\nA. 高兴的  B. 生气的  C. 伤心的", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"afraid\"的意思是（ ）。\nA. 害怕的  B. 高兴的  C. 累的", answer: "A", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你怎么了？\"，你应该说（ ）。\nA. How are you?  B. What is wrong?  C. Who are you?", answer: "B", difficulty: 1 },
      { type: "选择题", content: "\"I feel happy.\"的意思是（ ）。\nA. 我感觉很好。  B. 我感觉快乐。  C. 我感觉累了。", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"sad\"的意思是（ ）。\nA. 高兴的  B. 伤心的  C. 害怕的", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"worried\"的意思是（ ）。\nA. 担心的  B. 高兴的  C. 生气的", answer: "A", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nill —（ ）  wear warm clothes —（ ）", answer: "生病的；穿暖和的衣服", difficulty: 1 },
      { type: "情景交际", content: "你想安慰别人\"别担心\"，你应该说（ ）。\nA. Do not worry.  B. I am worried.  C. Thank you.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"happy\"的意思是（ ）。\nA. 伤心的  B. 高兴的  C. 生气的", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"He is angry.\"意思是\"他很生气\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g6s-u7",
    unitName: "What does he do? (拓展)",
    grade: 6,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"reporter\"的意思是（ ）。\nA. 记者  B. 医生  C. 老师", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"fisherman\"的意思是（ ）。\nA. 农民  B. 渔民  C. 工人", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"他在哪里工作？\"，你应该说（ ）。\nA. Where does he work?  B. What does he do?  C. How does he go to work?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"She works at sea.\"的意思是（ ）。\nA. 她在海边工作。  B. 她在医院工作。  C. 她在学校工作。", answer: "A", difficulty: 2 },
      { type: "单词选择", content: "\"coach\"的意思是（ ）。\nA. 老师  B. 教练  C. 医生", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nsecretary —（ ）  university —（ ）", answer: "秘书；大学", difficulty: 1 },
      { type: "情景交际", content: "你想说\"他是一名邮递员\"，你应该说（ ）。\nA. He is a postman.  B. She is a nurse.  C. He is a teacher.", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"What does she do?\"的回答可能是（ ）。\nA. She is kind.  B. She is a factory worker.  C. She is at home.", answer: "B", difficulty: 2 },
      { type: "单词选择", content: "\"writer\"的意思是（ ）。\nA. 歌手  B. 作家  C. 画家", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"He goes to work by bike.\"意思是\"他骑车去上班\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    id: "en-g6x-u6",
    unitName: "Last weekend (拓展)",
    grade: 6,
    semester: "下",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"watched TV\"的意思是（ ）。\nA. 看电视  B. 看了电视  C. 看电影", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"washed clothes\"的意思是（ ）。\nA. 洗衣服  B. 洗了衣服  C. 买衣服", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你上周末做了什么？\"，你应该说（ ）。\nA. What did you do last weekend?  B. What do you do?  C. What will you do?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"I played football yesterday.\"的意思是（ ）。\nA. 我昨天踢了足球。  B. 我明天要踢足球。  C. 我经常踢足球。", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"cleaned the room\"的意思是（ ）。\nA. 打扫房间  B. 打扫了房间  C. 整理房间", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nstayed at home —（ ）  read a book —（ ）", answer: "待在家里；读了一本书", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我上周末去了公园\"，你应该说（ ）。\nA. I went to the park last weekend.  B. I go to the park.  C. I will go to the park.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "\"Did you see a film?\"的肯定回答是（ ）。\nA. Yes, I do.  B. Yes, I did.  C. Yes, I am.", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"visited grandparents\"的意思是（ ）。\nA. 看望了祖父母  B. 拜访了朋友  C. 看了老师", answer: "A", difficulty: 1 },
      { type: "判断题", content: "\"last weekend\"指的是上周末。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"holiday\"的意思是（ ）。\nA. 假日  B. 星期  C. 月份", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"travel\"的意思是（ ）。\nA. 工作  B. 旅行  C. 学习", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你去哪里度假了？\"，你应该说（ ）。\nA. Where did you go on your holiday?  B. What did you do?  C. How are you?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"I went to Beijing.\"的意思是（ ）。\nA. 我去了北京。  B. 我去了上海。  C. 我去了广州。", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"beach\"的意思是（ ）。\nA. 山  B. 海滩  C. 森林", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"photo\"的意思是（ ）。\nA. 照片  B. 电影  C. 书", answer: "A", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\ntook pictures —（ ）  bought gifts —（ ）", answer: "拍了照片；买了礼物", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我拍了很多照片\"，你应该说（ ）。\nA. I took many pictures.  B. I took a picture.  C. I see a photo.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "\"How did you go there?\"的回答可能是（ ）。\nA. I went there by plane.  B. I went to Shanghai.  C. I like it.", answer: "A", difficulty: 2 },
      { type: "判断题", content: "\"went\"是\"go\"的过去式。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "蝴蝶的一生要经历（ ）、（ ）、（ ）、（ ）四个阶段。", answer: "卵；幼虫；蛹；成虫", difficulty: 1 },
      { type: "选择题", content: "蚕是从（ ）孵化出来的。\nA. 卵  B. 蛹  C. 幼虫", answer: "A", difficulty: 1 },
      { type: "判断题", content: "所有动物都经历卵、幼虫、蛹、成虫四个阶段。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "青蛙的幼体叫（ ），生活在（ ）中。", answer: "蝌蚪；水", difficulty: 1 },
      { type: "选择题", content: "下列动物中，经历完全变态发育的是（ ）。\nA. 青蛙  B. 蚊子  C. 鸡", answer: "B", difficulty: 2 },
      { type: "判断题", content: "蚕宝宝喜欢吃桑叶。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "蚕的一生经历（ ）、（ ）、（ ）、（ ）四个阶段。", answer: "卵；幼虫；蛹；成虫（蚕蛾）", difficulty: 1 },
      { type: "选择题", content: "鸡的发育方式是（ ）。\nA. 卵生  B. 胎生  C. 两者都不是", answer: "A", difficulty: 1 },
      { type: "判断题", content: "哺乳动物是胎生动物。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "请说出蝴蝶和蚕的生命周期有什么相同之处。", answer: "它们都要经历卵、幼虫、蛹、成虫四个阶段，都属于完全变态发育。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "温度的单位是（ ），用符号（ ）表示。", answer: "摄氏度；℃", difficulty: 1 },
      { type: "选择题", content: "水在（ ）时会结冰。\nA. 0℃  B. 100℃  C. 50℃", answer: "A", difficulty: 1 },
      { type: "选择题", content: "水在（ ）时会沸腾。\nA. 0℃  B. 100℃  C. 50℃", answer: "B", difficulty: 1 },
      { type: "判断题", content: "水结冰时体积会变小。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "水有三种状态：（ ）、（ ）、（ ）。", answer: "固态；液态；气态", difficulty: 1 },
      { type: "选择题", content: "测量温度的仪器叫（ ）。\nA. 尺子  B. 温度计  C. 天平", answer: "B", difficulty: 1 },
      { type: "判断题", content: "冰是固态的水。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "水蒸发时需要吸收（ ）。", answer: "热量", difficulty: 2 },
      { type: "选择题", content: "衣服晾在通风的地方干得快，是因为（ ）。\nA. 温度高  B. 风加快了蒸发  C. 太阳大", answer: "B", difficulty: 2 },
      { type: "简答题", content: "请说出水结冰和冰融化时温度有什么特点。", answer: "水结冰时温度降到0℃及以下，冰融化时温度保持在0℃直到全部融化。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "月球是地球的（ ）星。", answer: "天然卫星", difficulty: 1 },
      { type: "选择题", content: "月球绕地球公转一周大约需要（ ）。\nA. 一天  B. 一个月  C. 一年", answer: "B", difficulty: 1 },
      { type: "判断题", content: "月球自己会发光。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "月球上没有（ ），也没有（ ）。", answer: "空气；水", difficulty: 1 },
      { type: "选择题", content: "我们看到的月相变化是因为（ ）。\nA. 月球自己在变化  B. 月球绕地球公转  C. 太阳在变化", answer: "B", difficulty: 2 },
      { type: "判断题", content: "月球的引力比地球小。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "月球表面的坑叫（ ）。", answer: "环形山", difficulty: 1 },
      { type: "选择题", content: "第一个登上月球的宇航员是（ ）。\nA. 杨利伟  B. 阿姆斯特朗  C. 加加林", answer: "B", difficulty: 1 },
      { type: "判断题", content: "月球上白天和夜晚温差很大。（ ）", answer: "√", difficulty: 2 },
      { type: "简答题", content: "为什么月球上没有生命？", answer: "因为月球上没有空气和水，温度变化极大，不适合生命生存。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "地球是一个（ ）的球体。", answer: "不规则", difficulty: 1 },
      { type: "选择题", content: "最早证明地球是球形的事件是（ ）。\nA. 麦哲伦环球航行  B. 登月  C. 发射卫星", answer: "A", difficulty: 1 },
      { type: "判断题", content: "地球是完美的圆球体。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "地球的赤道半径约为（ ）千米。", answer: "6371", difficulty: 2 },
      { type: "选择题", content: "从太空看地球，地球是（ ）色的。\nA. 红色  B. 蓝色  C. 黄色", answer: "B", difficulty: 1 },
      { type: "判断题", content: "地球表面大部分是海洋。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "地球表面约（ ）%是海洋，约（ ）%是陆地。", answer: "71；29", difficulty: 2 },
      { type: "选择题", content: "地球绕着（ ）转。\nA. 月球  B. 太阳  C. 火星", answer: "B", difficulty: 1 },
      { type: "判断题", content: "地球是太阳系中最大的行星。（ ）", answer: "×", difficulty: 1 },
      { type: "简答题", content: "请列举两个证明地球是球形的证据。", answer: "1. 从海边看远处的船，先看到桅杆再看到船身；2. 月食时地球的影子是圆的；3. 麦哲伦环球航行。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "声音是由物体的（ ）产生的。", answer: "振动", difficulty: 1 },
      { type: "选择题", content: "声音可以在（ ）中传播。\nA. 空气  B. 水  C. 固体  D. 以上都可以", answer: "D", difficulty: 1 },
      { type: "判断题", content: "声音在真空中也能传播。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "声音在（ ）中传播最快，在（ ）中传播最慢。", answer: "固体；气体", difficulty: 2 },
      { type: "选择题", content: "声音是以（ ）的形式传播的。\nA. 光波  B. 声波  C. 电流", answer: "B", difficulty: 1 },
      { type: "判断题", content: "声音只能向一个方向传播。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "声音在15℃空气中的传播速度约为每秒（ ）米。", answer: "340", difficulty: 2 },
      { type: "选择题", content: "用手按住正在发声的琴弦，琴弦停止振动，声音（ ）。\nA. 变大  B. 变小  C. 消失", answer: "C", difficulty: 1 },
      { type: "判断题", content: "我们听到声音是因为声波传到了我们的耳朵里。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "为什么在月球上宇航员不能直接对话？", answer: "因为月球上没有空气，声音无法在真空中传播。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "人体消化食物的主要器官是（ ）。", answer: "小肠", difficulty: 1 },
      { type: "选择题", content: "食物消化的过程是从（ ）开始的。\nA. 胃  B. 口腔  C. 小肠", answer: "B", difficulty: 1 },
      { type: "判断题", content: "牙齿、舌头和唾液都参与食物的初步消化。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "人体的消化系统包括（ ）和（ ）两部分。", answer: "消化道；消化腺", difficulty: 2 },
      { type: "选择题", content: "营养物质主要在（ ）被吸收。\nA. 胃  B. 大肠  C. 小肠", answer: "C", difficulty: 1 },
      { type: "判断题", content: "大肠的作用是吸收水分。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "食物在（ ）中被进一步磨碎和分解。", answer: "胃", difficulty: 1 },
      { type: "选择题", content: "下列哪种做法有利于消化？（ ）\nA. 暴饮暴食  B. 细嚼慢咽  C. 边吃边玩", answer: "B", difficulty: 1 },
      { type: "判断题", content: "肝脏是最大的消化腺。（ ）", answer: "√", difficulty: 2 },
      { type: "简答题", content: "请说出食物在人体中的消化过程。", answer: "食物从口腔进入，经过食道到胃，再到小肠消化吸收，最后残渣进入大肠排出体外。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "一个完整的电路由（ ）、（ ）、（ ）、（ ）四部分组成。", answer: "电源；导线；开关；用电器", difficulty: 1 },
      { type: "选择题", content: "下列材料中，属于导体的是（ ）。\nA. 铜线  B. 塑料  C. 橡胶", answer: "A", difficulty: 1 },
      { type: "判断题", content: "绝缘体不能导电。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "电路中控制电流通断的元件是（ ）。", answer: "开关", difficulty: 1 },
      { type: "选择题", content: "下列材料中，属于绝缘体的是（ ）。\nA. 铁丝  B. 铝箔  C. 木棒", answer: "C", difficulty: 1 },
      { type: "判断题", content: "人体是导体。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "两个灯泡首尾相连的连接方式叫（ ）电路。", answer: "串联", difficulty: 2 },
      { type: "选择题", content: "串联电路中，一个灯泡坏了，其他灯泡（ ）。\nA. 还会亮  B. 不亮了  C. 更亮了", answer: "B", difficulty: 2 },
      { type: "判断题", content: "干电池的铜帽一端是正极。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "什么是短路？短路有什么危害？", answer: "短路是电流不经过用电器直接从正极流向负极。短路会产生很大的电流，可能烧坏电源或引起火灾。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "岩石按成因可以分为（ ）岩、（ ）岩和（ ）岩三大类。", answer: "岩浆；沉积；变质", difficulty: 1 },
      { type: "选择题", content: "花岗岩属于（ ）。\nA. 岩浆岩  B. 沉积岩  C. 变质岩", answer: "A", difficulty: 1 },
      { type: "判断题", content: "化石通常在沉积岩中找到。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "砂岩属于（ ）岩。", answer: "沉积", difficulty: 1 },
      { type: "选择题", content: "大理岩属于（ ）。\nA. 岩浆岩  B. 沉积岩  C. 变质岩", answer: "C", difficulty: 2 },
      { type: "判断题", content: "所有岩石都是坚硬的。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "我们可以通过观察岩石的（ ）、（ ）、（ ）等特征来鉴别岩石。", answer: "颜色；纹理；硬度", difficulty: 1 },
      { type: "选择题", content: "下列岩石中，遇盐酸会冒泡的是（ ）。\nA. 花岗岩  B. 大理岩  C. 砂岩", answer: "B", difficulty: 2 },
      { type: "判断题", content: "岩石在自然界中不会发生变化。（ ）", answer: "×", difficulty: 1 },
      { type: "简答题", content: "请说出岩浆岩和沉积岩的形成过程有什么不同。", answer: "岩浆岩是由岩浆冷却凝固形成的；沉积岩是由泥沙、碎石等沉积物经过长时间压实和胶结形成的。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "光在（ ）中沿直线传播。", answer: "均匀介质（或同一种物质）", difficulty: 1 },
      { type: "选择题", content: "下列现象中，不能用光的直线传播来解释的是（ ）。\nA. 影子的形成  B. 日食和月食  C. 彩虹", answer: "C", difficulty: 2 },
      { type: "判断题", content: "光从空气进入水中会发生折射。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "光的速度约为每秒（ ）万千米。", answer: "30", difficulty: 2 },
      { type: "选择题", content: "潜望镜利用了光的（ ）原理。\nA. 直线传播  B. 反射  C. 折射", answer: "B", difficulty: 1 },
      { type: "判断题", content: "白光是由七种颜色的光组成的。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "红、橙、黄、绿、蓝、靛、（ ）组成了白光。", answer: "紫", difficulty: 1 },
      { type: "选择题", content: "物体反射红色光，我们看到这个物体是（ ）色的。\nA. 红  B. 绿  C. 蓝", answer: "A", difficulty: 2 },
      { type: "判断题", content: "黑色的物体会吸收所有颜色的光。（ ）", answer: "√", difficulty: 2 },
      { type: "简答题", content: "请解释为什么我们能看到不发光的物体。", answer: "因为不发光的物体反射了其他光源的光，这些反射光进入了我们的眼睛。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "地球自转一周需要（ ）小时。", answer: "24", difficulty: 1 },
      { type: "选择题", content: "地球自转产生了（ ）现象。\nA. 四季变化  B. 昼夜交替  C. 月相变化", answer: "B", difficulty: 1 },
      { type: "判断题", content: "地球是绕着太阳公转的。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "地球公转一周需要（ ）天。", answer: "365（或365.25）", difficulty: 1 },
      { type: "选择题", content: "地球公转产生了（ ）现象。\nA. 昼夜交替  B. 四季变化  C. 潮汐", answer: "B", difficulty: 1 },
      { type: "判断题", content: "太阳光直射在哪个半球，哪个半球就是夏季。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "地球自转的方向是自（ ）向（ ）。", answer: "西；东", difficulty: 1 },
      { type: "选择题", content: "当我们这里是白天时，地球另一面是（ ）。\nA. 白天  B. 黑夜  C. 黄昏", answer: "B", difficulty: 1 },
      { type: "判断题", content: "地球的公转轨道是圆形的。（ ）", answer: "×", difficulty: 2 },
      { type: "简答题", content: "请解释为什么会有四季变化。", answer: "因为地球是倾斜着绕太阳公转的，公转过程中太阳直射点在南北回归线之间移动，导致各地获得的太阳热量不同，从而产生四季变化。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "热传递有三种方式：（ ）、（ ）、（ ）。", answer: "传导；对流；辐射", difficulty: 1 },
      { type: "选择题", content: "用手摸铁勺和木勺，铁勺感觉更凉，是因为铁的导热性（ ）。\nA. 好  B. 差  C. 一样", answer: "A", difficulty: 1 },
      { type: "判断题", content: "热总是从温度高的地方传向温度低的地方。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "水变热后，热水会（ ），冷水会（ ），这叫对流。", answer: "上升；下降", difficulty: 2 },
      { type: "选择题", content: "太阳的热传到地球的方式是（ ）。\nA. 传导  B. 对流  C. 辐射", answer: "C", difficulty: 1 },
      { type: "判断题", content: "空气是热的良导体。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "保温瓶能保温，是因为它能减少热的（ ）。", answer: "传递（或散失）", difficulty: 2 },
      { type: "选择题", content: "下列材料中，导热性最好的是（ ）。\nA. 木头  B. 塑料  C. 铜", answer: "C", difficulty: 1 },
      { type: "判断题", content: "冬天穿棉衣觉得暖和，是因为棉衣能产生热量。（ ）", answer: "×", difficulty: 2 },
      { type: "简答题", content: "请解释保温瓶为什么能保温。", answer: "保温瓶有双层玻璃壁，中间抽成真空，减少了传导和对流；内壁镀银，减少了辐射。所以能减少热量的散失，起到保温作用。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "垃圾减量的三个原则是（ ）、（ ）、（ ）。", answer: "减少；重复使用；回收", difficulty: 1 },
      { type: "选择题", content: "下列垃圾中，属于可回收物的是（ ）。\nA. 废纸  B. 果皮  C. 电池", answer: "A", difficulty: 1 },
      { type: "判断题", content: "垃圾分类有利于环境保护。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "（ ）是地球面临的最严重的环境问题之一。", answer: "全球变暖（或气候变暖）", difficulty: 1 },
      { type: "选择题", content: "下列做法中，不利于环保的是（ ）。\nA. 节约用水  B. 随意丢弃塑料袋  C. 绿色出行", answer: "B", difficulty: 1 },
      { type: "判断题", content: "塑料在自然界中很容易降解。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "减少白色污染，我们应该少使用（ ）制品。", answer: "塑料", difficulty: 1 },
      { type: "选择题", content: "下列能源中，属于可再生能源的是（ ）。\nA. 煤炭  B. 石油  C. 太阳能", answer: "C", difficulty: 1 },
      { type: "判断题", content: "植树造林可以减少空气中的二氧化碳。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "请说出三种保护环境的方法。", answer: "1. 节约用水用电；2. 垃圾分类回收；3. 绿色出行，减少汽车尾气排放。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "生物多样性包括（ ）多样性、（ ）多样性和（ ）多样性三个层次。", answer: "基因；物种；生态系统", difficulty: 2 },
      { type: "选择题", content: "下列动物中，属于濒危动物的是（ ）。\nA. 麻雀  B. 大熊猫  C. 家鸡", answer: "B", difficulty: 1 },
      { type: "判断题", content: "生物多样性对维持生态平衡很重要。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "建立（ ）是保护生物多样性的有效措施之一。", answer: "自然保护区", difficulty: 1 },
      { type: "选择题", content: "下列做法中，有利于保护生物多样性的是（ ）。\nA. 乱砍滥伐  B. 建立自然保护区  C. 随意捕杀野生动物", answer: "B", difficulty: 1 },
      { type: "判断题", content: "每一种生物在生态系统中都有其独特的作用。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "（ ）是一种珍稀的淡水豚，被称为\"水中大熊猫\"。", answer: "白鳍豚", difficulty: 2 },
      { type: "选择题", content: "食物链中，如果一种生物消失了，其他生物（ ）。\nA. 不受影响  B. 会受到影响  C. 会全部消失", answer: "B", difficulty: 1 },
      { type: "判断题", content: "外来物种入侵会威胁本地生物多样性。（ ）", answer: "√", difficulty: 2 },
      { type: "简答题", content: "为什么我们要保护生物多样性？", answer: "因为每种生物都在生态系统中扮演着重要角色，保护生物多样性就是保护我们赖以生存的生态环境，维持生态平衡。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "物质的变化分为（ ）变化和（ ）变化两类。", answer: "物理；化学", difficulty: 1 },
      { type: "选择题", content: "下列变化中，属于化学变化的是（ ）。\nA. 铁丝弯曲  B. 木头燃烧  C. 冰融化", answer: "B", difficulty: 1 },
      { type: "判断题", content: "物理变化中不会产生新的物质。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "铁生锈是一种（ ）变化。", answer: "化学", difficulty: 1 },
      { type: "选择题", content: "下列变化中，属于物理变化的是（ ）。\nA. 蜡烛燃烧  B. 铁生锈  C. 纸撕碎", answer: "C", difficulty: 1 },
      { type: "判断题", content: "化学变化中一定伴随着物理变化。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "判断化学变化的标志是（ ）。", answer: "有新物质生成", difficulty: 1 },
      { type: "选择题", content: "下列现象中，既有物理变化又有化学变化的是（ ）。\nA. 蜡烛燃烧  B. 水结冰  C. 铁丝弯曲", answer: "A", difficulty: 2 },
      { type: "判断题", content: "所有发光发热的变化都是化学变化。（ ）", answer: "×", difficulty: 2 },
      { type: "简答题", content: "请说出物理变化和化学变化的区别。", answer: "物理变化没有产生新物质，化学变化产生了新的物质。化学变化常伴有发光、发热、变色、产生气体或沉淀等现象。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "太阳系有（ ）大行星。", answer: "八", difficulty: 1 },
      { type: "选择题", content: "太阳系中最大的行星是（ ）。\nA. 地球  B. 木星  C. 土星", answer: "B", difficulty: 1 },
      { type: "判断题", content: "太阳是一颗恒星。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "离太阳最近的行星是（ ），离太阳最远的行星是（ ）。", answer: "水星；海王星", difficulty: 1 },
      { type: "选择题", content: "银河系大约有（ ）颗恒星。\nA. 几百  B. 几千  C. 几千亿", answer: "C", difficulty: 2 },
      { type: "判断题", content: "月球是太阳系的行星之一。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "太阳系中，有光环的行星是（ ）和（ ）。", answer: "土星；木星", difficulty: 2 },
      { type: "选择题", content: "我们居住的星球是（ ）。\nA. 火星  B. 金星  C. 地球", answer: "C", difficulty: 1 },
      { type: "判断题", content: "宇宙是无边无际的。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "请按离太阳从近到远的顺序说出八大行星。", answer: "水星、金星、地球、火星、木星、土星、天王星、海王星。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "中国第一位进入太空的航天员是（ ）。", answer: "杨利伟", difficulty: 1 },
      { type: "选择题", content: "中国的空间站叫（ ）。\nA. 天宫  B. 和平号  C. 国际空间站", answer: "A", difficulty: 1 },
      { type: "判断题", content: "人类已经登上了火星。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "用来观测遥远天体的仪器叫（ ）。", answer: "望远镜", difficulty: 1 },
      { type: "选择题", content: "人类第一次登月是在（ ）年。\nA. 1965  B. 1969  C. 1975", answer: "B", difficulty: 2 },
      { type: "判断题", content: "火箭是利用反冲原理升空的。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "中国的探月工程叫（ ）工程。", answer: "嫦娥", difficulty: 1 },
      { type: "选择题", content: "下列哪个不是太空探测方式？（ ）\nA. 航天飞机  B. 望远镜  C. 潜水艇", answer: "C", difficulty: 1 },
      { type: "判断题", content: "探索宇宙可以帮助我们了解地球的起源。（ ）", answer: "√", difficulty: 1 },
      { type: "简答题", content: "请说出人类探索宇宙的意义。", answer: "探索宇宙可以帮助我们了解地球和太阳系的起源，寻找新的资源和生存空间，推动科学技术的发展。", difficulty: 2 }
    ],
  }
,

  {
    ...
    subject: "数学",
    questions: [
      { type: "选择题", content: "从前面看一个正方体，看到的是（ ）。\nA. 正方形  B. 长方形  C. 三角形", answer: "A", difficulty: 1 },
      { type: "选择题", content: "从上面看一个长方体，看到的是（ ）。\nA. 正方形  B. 长方形  C. 圆形", answer: "B", difficulty: 1 },
      { type: "判断题", content: "从不同方向看同一个物体，看到的形状可能不同。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "一个物体，从正面看是正方形，从侧面看也是正方形，这个物体可能是（ ）。", answer: "正方体或圆柱（竖放）", difficulty: 2 },
      { type: "选择题", content: "从右面看一个圆柱，看到的是（ ）。\nA. 圆  B. 长方形  C. 三角形", answer: "B", difficulty: 1 },
      { type: "判断题", content: "从任何方向看球，看到的都是圆形。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "从上面看一个圆柱，看到的是（ ）形。", answer: "圆", difficulty: 1 },
      { type: "选择题", content: "一个物体从正面和左面看到的都是长方形，这个物体可能是（ ）。\nA. 正方体  B. 长方体  C. 球", answer: "B", difficulty: 2 },
      { type: "判断题", content: "观察物体时，最多只能看到三个面。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "用3个正方体拼成一个长方体，从正面看有（ ）个正方形。", answer: "3", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "一年有（ ）个月，其中大月有（ ）个，小月有（ ）个。", answer: "12；7；4", difficulty: 1 },
      { type: "选择题", content: "下列月份中，大月是（ ）。\nA. 4月  B. 6月  C. 8月", answer: "C", difficulty: 1 },
      { type: "判断题", content: "2月只有28天。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "平年全年有（ ）天，闰年全年有（ ）天。", answer: "365；366", difficulty: 1 },
      { type: "选择题", content: "下列年份中，是闰年的是（ ）。\nA. 2021年  B. 2024年  C. 2023年", answer: "B", difficulty: 2 },
      { type: "填空题", content: "闰年的2月有（ ）天。", answer: "29", difficulty: 1 },
      { type: "判断题", content: "公历年份是4的倍数的一定是闰年。（ ）", answer: "×", difficulty: 2 },
      { type: "填空题", content: "1月、3月、5月、7月、8月、10月、12月，每月有（ ）天。", answer: "31", difficulty: 1 },
      { type: "选择题", content: "小明的生日是9月1日，这个月有（ ）天。\nA. 30  B. 31  C. 28", answer: "A", difficulty: 1 },
      { type: "应用题", content: "小明从7月15日到8月5日去参加夏令营，一共去了多少天？", answer: "31-15+1+5=22（天）", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "条形统计图是用（ ）的高低来表示数量的多少。", answer: "直条", difficulty: 1 },
      { type: "选择题", content: "条形统计图的优点是（ ）。\nA. 能清楚地看出各数量的多少  B. 能看出变化趋势  C. 能看出部分与总体的关系", answer: "A", difficulty: 1 },
      { type: "判断题", content: "条形统计图的每格代表的数量可以不同。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "画条形统计图时，要写出（ ）、画出图例、标出数据。", answer: "标题", difficulty: 1 },
      { type: "选择题", content: "在条形统计图中，直条越（ ），表示数量越多。\nA. 长  B. 短  C. 宽", answer: "A", difficulty: 1 },
      { type: "判断题", content: "条形统计图可以横向画，也可以纵向画。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "统计表和条形统计图相比，条形统计图更（ ）。", answer: "直观", difficulty: 1 },
      { type: "应用题", content: "下面是四（1）班同学喜欢的水果统计：苹果8人、香蕉12人、橘子6人、葡萄10人。喜欢（ ）的人最多。", answer: "香蕉", difficulty: 1 },
      { type: "选择题", content: "条形统计图中，一格代表5人，某项数据画了3格半，这项数据是（ ）人。\nA. 15  B. 17.5  C. 18", answer: "B", difficulty: 2 },
      { type: "判断题", content: "条形统计图只能用来统计人数。（ ）", answer: "×", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "图形的运动有（ ）、（ ）、（ ）三种基本方式。", answer: "平移；旋转；轴对称", difficulty: 1 },
      { type: "选择题", content: "下列图形中，是轴对称图形的是（ ）。\nA. 平行四边形  B. 等腰三角形  C. 梯形", answer: "B", difficulty: 1 },
      { type: "判断题", content: "平移只改变图形的位置，不改变图形的形状和大小。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "正方形有（ ）条对称轴。", answer: "4", difficulty: 1 },
      { type: "选择题", content: "时钟的分针运动是（ ）现象。\nA. 平移  B. 旋转  C. 对称", answer: "B", difficulty: 1 },
      { type: "判断题", content: "旋转不改变图形的形状和大小。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "等边三角形有（ ）条对称轴。", answer: "3", difficulty: 1 },
      { type: "选择题", content: "把一个图形向右平移3格，图形的（ ）不变。\nA. 位置  B. 形状和大小  C. 方向", answer: "B", difficulty: 1 },
      { type: "判断题", content: "圆有无数条对称轴。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "旋转的三要素是（ ）、（ ）、（ ）。", answer: "旋转中心；旋转方向；旋转角度", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "数学",
    questions: [
      { type: "填空题", content: "用图形可以帮助我们理解（ ）的规律。", answer: "数", difficulty: 1 },
      { type: "选择题", content: "1+3+5+7 =（ ），这个规律可以用（ ）来解释。\nA. 16；正方形  B. 15；三角形  C. 14；圆形", answer: "A", difficulty: 2 },
      { type: "判断题", content: "从1开始的连续奇数的和等于奇数个数的平方。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "1+3 =（ ）的平方，1+3+5 =（ ）的平方。", answer: "2；3", difficulty: 1 },
      { type: "选择题", content: "1+3+5+7+9 =（ ）。\nA. 25  B. 36  C. 16", answer: "A", difficulty: 2 },
      { type: "判断题", content: "数形结合是一种重要的数学思想方法。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "用小正方形拼成大正方形，第n个大正方形需要（ ）个小正方形。", answer: "n的平方", difficulty: 2 },
      { type: "选择题", content: "1+3+5+7+9+11 =（ ）。\nA. 25  B. 36  C. 49", answer: "B", difficulty: 2 },
      { type: "判断题", content: "连续偶数的和也有类似的规律。（ ）", answer: "√", difficulty: 3 },
      { type: "填空题", content: "1+2+3+4+5+4+3+2+1 =（ ），这个规律可以用（ ）来解释。", answer: "25；三角形", difficulty: 3 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "蒲公英靠（ ）传播种子。", answer: "风", difficulty: 1 },
      { type: "填空题", content: "苍耳靠（ ）传播种子。", answer: "动物皮毛", difficulty: 1 },
      { type: "选择题", content: "豌豆靠（ ）传播种子。\nA. 风  B. 水  C. 太阳", answer: "C", difficulty: 1 },
      { type: "判断题", content: "植物妈妈有很多办法来传播种子。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文中，蒲公英像（ ）一样在风中飞舞。", answer: "降落伞", difficulty: 1 },
      { type: "选择题", content: "石榴靠（ ）传播种子。\nA. 风  B. 动物  C. 水", answer: "B", difficulty: 2 },
      { type: "判断题", content: "所有的植物都用同一种方式传播种子。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "这篇课文是一首关于（ ）的诗歌。", answer: "植物传播种子", difficulty: 1 },
      { type: "选择题", content: "课文的体裁是（ ）。\nA. 记叙文  B. 诗歌  C. 说明文", answer: "B", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我知道了植物传播种子的方法有（ ）、（ ）、（ ）等。", answer: "风力传播；动物传播；弹射传播", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文写了（ ）和（ ）之间的故事。", answer: "鸟儿；树", difficulty: 1 },
      { type: "选择题", content: "鸟儿为了遵守对树的承诺，飞回来寻找（ ）。\nA. 树  B. 树根  C. 火柴", answer: "B", difficulty: 1 },
      { type: "判断题", content: "树被砍伐后变成了火柴。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "鸟儿最后对着（ ）唱了去年的歌。", answer: "灯火", difficulty: 1 },
      { type: "选择题", content: "这篇课文的作者是（ ）。\nA. 安徒生  B. 新美南吉  C. 格林兄弟", answer: "B", difficulty: 2 },
      { type: "判断题", content: "鸟儿是一个信守承诺的朋友。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文的主题是（ ）。", answer: "守信和友情", difficulty: 2 },
      { type: "选择题", content: "鸟儿为什么要唱歌给灯火听？（ ）\nA. 因为灯火很亮  B. 因为灯火是树的化身  C. 因为鸟儿喜欢唱歌", answer: "B", difficulty: 2 },
      { type: "判断题", content: "这篇童话语言简洁，感情真挚。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我懂得了（ ）的重要。", answer: "信守承诺", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "爬山虎的脚长在（ ）上。", answer: "茎", difficulty: 1 },
      { type: "选择题", content: "爬山虎是靠（ ）往上爬的。\nA. 藤蔓  B. 脚  C. 叶子", answer: "B", difficulty: 1 },
      { type: "判断题", content: "爬山虎的脚像蛟龙的爪子。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "爬山虎的脚触着墙的时候，会变成（ ）色。", answer: "灰", difficulty: 1 },
      { type: "选择题", content: "课文的作者是（ ）。\nA. 老舍  B. 巴金  C. 叶圣陶", answer: "C", difficulty: 1 },
      { type: "判断题", content: "爬山虎的叶子一顺儿朝下。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "爬山虎新长出来的叶子是（ ）色的。", answer: "嫩红", difficulty: 1 },
      { type: "选择题", content: "课文主要运用了（ ）的观察方法。\nA. 远看  B. 近看  C. 连续观察", answer: "C", difficulty: 2 },
      { type: "判断题", content: "没有触着墙的爬山虎的脚会枯萎。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "学了这篇课文，我体会到了作者（ ）的精神。", answer: "仔细观察", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "课文的作者是（ ）。", answer: "琦君", difficulty: 1 },
      { type: "选择题", content: "\"桂花雨\"指的是（ ）。\nA. 下雨  B. 摇桂花时桂花纷纷落下的样子  C. 桂花上的露水", answer: "B", difficulty: 1 },
      { type: "判断题", content: "母亲喜欢桂花是因为桂花很香。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文表达了作者对（ ）的思念。", answer: "家乡", difficulty: 1 },
      { type: "选择题", content: "桂花盛开的时候，整个院子都（ ）。\nA. 很安静  B. 充满香味  C. 很冷清", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"桂花雨\"是作者童年最美好的回忆之一。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "母亲说\"这里的桂花再香，也比不上家乡院子里的桂花\"，这句话表达了母亲对（ ）的思念。", answer: "家乡", difficulty: 2 },
      { type: "选择题", content: "这篇课文主要写了（ ）。\nA. 桂花的种植方法  B. 童年摇桂花的快乐和对家乡的思念  C. 桂花的用途", answer: "B", difficulty: 1 },
      { type: "判断题", content: "作者后来离开了家乡。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "课文借（ ）表达了对（ ）的思念之情。", answer: "桂花；家乡", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "语文",
    questions: [
      { type: "填空题", content: "《少年闰土》的作者是（ ）。", answer: "鲁迅", difficulty: 1 },
      { type: "选择题", content: "闰土给\"我\"讲了（ ）件事。\nA. 两  B. 三  C. 四", answer: "C", difficulty: 1 },
      { type: "判断题", content: "闰土是一个见多识广的农村少年。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "闰土给\"我\"讲了（ ）、（ ）、（ ）、（ ）四件事。", answer: "雪地捕鸟；海边拾贝；看瓜刺猹；看跳鱼儿", difficulty: 2 },
      { type: "选择题", content: "\"我\"和闰土的关系是（ ）。\nA. 同学  B. 朋友  C. 亲戚", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"我\"很羡慕闰土的生活。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "闰土生活在（ ），\"我\"生活在城里。", answer: "农村", difficulty: 1 },
      { type: "选择题", content: "课文中，闰土的形象是（ ）。\nA. 胆小怕事  B. 聪明能干、活泼可爱  C. 懒惰", answer: "B", difficulty: 1 },
      { type: "判断题", content: "课文表达了\"我\"对闰土的敬佩和对自由生活的向往。（ ）", answer: "√", difficulty: 2 },
      { type: "填空题", content: "课文通过（ ）和（ ）的对比，突出了闰土的特点。", answer: "\"我\"；闰土", difficulty: 2 }
    ],
  },

  {
    id: "en-g3s-u8",
    unitName: "Let us go to school!",
    grade: 3,
    semester: "上",
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"school\"的意思是（ ）。\nA. 家  B. 学校  C. 医院", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"bag\"的意思是（ ）。\nA. 书  B. 笔  C. 书包", answer: "C", difficulty: 1 },
      { type: "单词选择", content: "\"pen\"的意思是（ ）。\nA. 钢笔  B. 铅笔  C. 尺子", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"pencil\"的意思是（ ）。\nA. 钢笔  B. 铅笔  C. 橡皮", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我有一支新钢笔\"，你应该说（ ）。\nA. I have a new pen.  B. I have a new bag.  C. I have a new book.", answer: "A", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nruler —（ ）  eraser —（ ）", answer: "尺子；橡皮", difficulty: 1 },
      { type: "情景交际", content: "你想说\"这是什么？\"，你应该说（ ）。\nA. What is this?  B. Who is this?  C. How is this?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"What is that?\"的回答可能是（ ）。\nA. It is a book.  B. I am fine.  C. My name is Tom.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"book\"的意思是（ ）。\nA. 书  B. 笔  C. 桌子", answer: "A", difficulty: 1 },
      { type: "判断题", content: "\"I have a ruler.\"意思是\"我有一把尺子\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    questions: [
      { type: "单词选择", content: "\"bedroom\"的意思是（ ）。\nA. 客厅  B. 卧室  C. 厨房", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"living room\"的意思是（ ）。\nA. 卧室  B. 浴室  C. 客厅", answer: "C", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我的家很温馨\"，你应该说（ ）。\nA. My home is nice.  B. My home is big.  C. My home is bad.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"sofa\"的意思是（ ）。\nA. 桌子  B. 沙发  C. 床", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"fridge\"的意思是（ ）。\nA. 电视  B. 冰箱  C. 电话", answer: "B", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\ntable —（ ）  phone —（ ）", answer: "桌子；电话", difficulty: 1 },
      { type: "情景交际", content: "你想说\"沙发在客厅里\"，你应该说（ ）。\nA. The sofa is in the living room.  B. The sofa is in the bedroom.  C. The sofa is in the kitchen.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "\"Where is the bed?\"的回答可能是（ ）。\nA. It is in the bedroom.  B. It is a bed.  C. I like the bed.", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"phone\"的意思是（ ）。\nA. 电视  B. 电话  C. 电脑", answer: "B", difficulty: 1 },
      { type: "判断题", content: "\"There is a bed in the bedroom.\"意思是\"卧室里有一张床\"。（ ）", answer: "√", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "英语",
    questions: [
      { type: "单词选择", content: "\"usually\"的意思是（ ）。\nA. 通常  B. 从不  C. 有时", answer: "A", difficulty: 1 },
      { type: "单词选择", content: "\"sometimes\"的意思是（ ）。\nA. 总是  B. 有时  C. 从不", answer: "B", difficulty: 1 },
      { type: "情景交际", content: "你想问\"你周末通常做什么？\"，你应该说（ ）。\nA. What do you usually do on the weekend?  B. What are you doing?  C. What did you do?", answer: "A", difficulty: 1 },
      { type: "选择题", content: "\"I always get up at 7:00.\"的意思是（ ）。\nA. 我通常7点起床  B. 我总是7点起床  C. 我有时7点起床", answer: "B", difficulty: 1 },
      { type: "单词选择", content: "\"never\"的意思是（ ）。\nA. 总是  B. 通常  C. 从不", answer: "C", difficulty: 1 },
      { type: "英汉互译", content: "将下列英文翻译成中文：\nalways —（ ）  often —（ ）", answer: "总是；经常", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我经常骑自行车上学\"，你应该说（ ）。\nA. I often go to school by bike.  B. I never go to school by bike.  C. I always walk to school.", answer: "A", difficulty: 2 },
      { type: "选择题", content: "频率从高到低排列正确的是（ ）。\nA. always > usually > often > sometimes > never  B. never > sometimes > often > usually > always", answer: "A", difficulty: 2 },
      { type: "判断题", content: "\"sometimes\"的频率比\"usually\"高。（ ）", answer: "×", difficulty: 1 },
      { type: "情景交际", content: "你想说\"我从不迟到\"，你应该说（ ）。\nA. I am never late.  B. I am always late.  C. I am sometimes late.", answer: "A", difficulty: 1 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "影子产生的条件是有（ ）、（ ）和（ ）。", answer: "光源；物体；屏幕（或地面）", difficulty: 1 },
      { type: "选择题", content: "影子在（ ）方向。\nA. 光源的反方向  B. 光源的方向  C. 任意方向", answer: "A", difficulty: 1 },
      { type: "判断题", content: "光源越强，影子越清晰。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "一天中，太阳的位置从（ ）方升起到（ ）方落下。", answer: "东；西", difficulty: 1 },
      { type: "选择题", content: "中午太阳在（ ）方，影子最（ ）。\nA. 东；长  B. 南；短  C. 西；长", answer: "B", difficulty: 2 },
      { type: "判断题", content: "影子的方向和太阳的方向相同。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "物体离光源越近，影子越（ ）。", answer: "大", difficulty: 2 },
      { type: "选择题", content: "下列物体中，是光源的是（ ）。\nA. 月亮  B. 镜子  C. 太阳", answer: "C", difficulty: 1 },
      { type: "判断题", content: "月亮是光源。（ ）", answer: "×", difficulty: 1 },
      { type: "简答题", content: "请说出一天中影子长度是怎样变化的。", answer: "早晨影子较长，中午影子最短，傍晚影子又变长。", difficulty: 2 }
    ],
  },

  {
    ...
    subject: "科学",
    questions: [
      { type: "填空题", content: "食物中含有的主要营养成分有（ ）、（ ）、（ ）、（ ）、（ ）和（ ）。", answer: "蛋白质；脂肪；糖类；维生素；矿物质；水", difficulty: 1 },
      { type: "选择题", content: "下列食物中，富含蛋白质的是（ ）。\nA. 米饭  B. 鸡蛋  C. 苹果", answer: "B", difficulty: 1 },
      { type: "判断题", content: "脂肪是人体的主要能量来源。（ ）", answer: "√", difficulty: 1 },
      { type: "填空题", content: "（ ）是人体最重要的营养素，约占体重的60%-70%。", answer: "水", difficulty: 1 },
      { type: "选择题", content: "下列食物中，富含维生素的是（ ）。\nA. 猪肉  B. 白菜  C. 大米", answer: "B", difficulty: 1 },
      { type: "判断题", content: "我们每天只需要吃一种食物就能获得全部营养。（ ）", answer: "×", difficulty: 1 },
      { type: "填空题", content: "（ ）是构成人体的基本物质。", answer: "蛋白质", difficulty: 1 },
      { type: "选择题", content: "下列食物中，富含淀粉（糖类）的是（ ）。\nA. 鸡蛋  B. 鱼肉  C. 面包", answer: "C", difficulty: 1 },
      { type: "判断题", content: "合理膳食 means eating a balanced diet。（ ）", answer: "√", difficulty: 2 },
      { type: "简答题", content: "为什么我们不能挑食？", answer: "因为每种食物含有的营养成分不同，挑食会导致某些营养素缺乏，影响身体健康。", difficulty: 2 }
    ],
  }];
