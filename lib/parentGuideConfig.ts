...
export const PARENT_GUIDE_TOPICS: ParentGuideTopic[] = [
  {
    ...
    title: '幼小衔接完全指南',
    description: '从幼儿园到小学的过渡准备完全指南：心理建设、学习习惯培养、能力储备（握笔坐姿专注力）、知识衔接（10以内加减法与拼音字母），含心理过渡、能力训练、知识衔接、作息调整四大模块，让孩子在9月1日从容入学，配练学宝口算与拼音工具，适合5-7岁大班幼小衔接，家长必备，配答案详解，可重复打印，永久免费，题型循序渐进。',
    icon: '🎒',
    color: 'blue',
    ageRange: '5-7岁',
    keyPoints: [
  ...
  },
  {
    id: 'study-habits',
    title: '学习习惯培养12招',
    description: '12个经过验证的小学学习习惯培养方法，从专注力训练、固定学习时间、番茄钟学习法到错题本建立与复习三步法，每个方法含具体步骤与执行建议，按低中高年级分层，让家长少操心，适合1-6年级全程使用，配练学宝口算速练与单元测试卷工具巩固，家长辅导好帮手，配答案详解，可重复打印，永久免费，题型循序渐进，含详细解析与批改参考。',
    icon: '⭐',
    color: 'emerald',
    ageRange: '6-12岁',
    keyPoints: [
  ...
  },
  {
    ...
    title: '辅导作业不吼叫',
    description: '辅导作业是每个家长的"必修课"。教你5个不吼叫的辅导方法：角色定位、启发式提问、分段完成、先签字后检查，含分段时长建议与情绪管理技巧，让辅导作业从"鸡飞狗跳"变成"母慈子孝"，适合1-6年级，配练学宝数学练习卷与单元测试卷工具使用，家长辅导必备，配答案详解，可重复打印，永久免费，题型循序渐进，含详细解析与批改参考。',
    icon: '🤝',
    color: 'orange',
    ageRange: '6-12岁',
    keyPoints: [
  ...
  },
  {
    id: 'time-management',
    title: '时间管理从小抓起',
    description: '孩子拖拉磨蹭不会规划时间？3个方法（任务清单法、时间可视化、优先级四象限训练）+1个时间银行工具，含沙漏倒计时使用建议与奖励机制，让孩子成为时间的主人，养成按时完成作业的好习惯，适合2-6年级，配练学宝口算速练工具计时训练，家长辅导好帮手，配答案详解，可重复打印，永久免费，题型循序渐进，含详细解析与批改参考。',
    icon: '⏰',
    color: 'rose',
    ageRange: '7-12岁',
    keyPoints: [
  ...
  },
  {
    id: 'reading-habit',
    title: '阅读习惯培养路线图',
    description: '从亲子阅读到独立阅读的完整路线图，分3-6岁绘本、6-8岁桥梁书、8-10岁章节书、10-12岁经典名著四个阶段，每个阶段含推荐书单与共读方法，告诉你每个年龄段该怎么做，适合3-12岁全程，配练学宝古诗词默写与作文模板工具延伸，家长辅导好帮手，配答案详解，可重复打印，永久免费，题型循序渐进，含详细解析与批改参考。',
    icon: '📚',
    color: 'purple',
    ageRange: '3-12岁',
    keyPoints: [
  ...
  },
  {
    ...
    title: '小升初择校与备考',
    description: '五六年级家长必看的小升初择校与备考指南：择校三要素、5-6年级学习规划、面试自我介绍准备、心态调整四大模块，含距离校风特色建议与模拟测试安排，让孩子从容面对小升初，配练学宝单元测试卷与小升初模拟卷工具，适合10-12岁，家长辅导好帮手，配答案详解，可重复打印，永久免费，题型循序渐进，含详细解析与批改参考。',
    icon: '🎯',
    color: 'yellow',
    ageRange: '10-12岁',
    keyPoints: [
